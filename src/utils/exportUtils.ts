...
export const shareReport = (suiteId: string, executionId: string) => {
  const shareUrl = `${window.location.origin}/executions/report/test_suite/${suiteId}?executionId=${executionId}`;
