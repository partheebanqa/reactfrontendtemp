...
const BEARER_TOKEN = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..fEaGRR3an3hKLFlzqi4vNQRupeOz7fXdZzvj7tBuRW8`;
...
export const addRequestsToTestSuite = async (
  ...
  try {
    ...
    throw new Error(error.response?.data?.message || 'Failed to add requests to test suite');
  }
};
