...
import Logo from '../assests/images/OptraLogo-removebg-preview.png';
                ...
                <div className="text-center">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-center space-x-1">
                            <div className="w-2 h-2 bg-[#136fb0] rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                            <div className="w-2 h-2 bg-[#136fb0] rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                            <div className="w-2 h-2 bg-[#136fb0] rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
                        </div>
                    </div>
