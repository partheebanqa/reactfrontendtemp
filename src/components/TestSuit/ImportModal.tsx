...
export const ImportModal: React.FC<ImportModalProps> = ({
  ...
  const isCreateTestSuitePrereqRoute =
    ...
    window.location.href.includes('/test-suites/create?step=prerequisites');
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className='max-w-4xl max-h-[90vh] overflow-auto scrollbar-thin flex flex-col'>
                                            ...
                                            <FolderTreeItem
                                              ...
                                              isLocked={
                                                isCreateTestSuitePrereqRoute
                                                  ? false
                                                  : isLocked
                                              } // 🔒 only lock in normal mode
                                              isPrereqMode={
                                                isCreateTestSuitePrereqRoute
                                              }
                                              allowedDomain={allowedDomain}
                                              isSelectApisMode={
                                                isCreateTestSuiteSelectApisRoute
                                              }
                                            />
                                          );
                                        })}
