                            ...
                            <>
                              ...
                              <div className='absolute right-0 mt-2 w-48 bg-background rounded-lg shadow-md border border-border py-1 z-20'>
                                ...
                                <button
                                  ...
                                  className='w-full px-4 py-2 text-left text-sm text-foreground hover:bg-muted flex items-center gap-33'
                                >
              ...
              <div className='p-4 space-y-3'>
                ...
                <div className='flex items-center gap-2 pt-2 border-t border-slate-100'>
                  <button
                    type='button'
                    onClick={() => handleAction('execute', suite)}
                    className='flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-primary text-primary-foreground rounded-lg text-xs font-medium hover:opacity-90 transition-opacity'
                  >
                    <Play className='w-4 h-4' />
