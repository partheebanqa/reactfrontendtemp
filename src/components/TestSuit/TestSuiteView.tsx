  ...
  const testCases = [
    {
      ...
      description: 'Verify the request returns a successful response (2xx status code)',
      type: 'Functional',
      expanded: true
    },
    {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white px-8 py-6 border-b border-gray-200">
        ...
        <div className="text-sm text-gray-600 mb-6">
          <span className="font-medium">Test Suite ID:</span> 4f67da18-fd98-460f-aaac-d636390790c41
