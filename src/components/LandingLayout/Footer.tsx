      ...
      <div className='max-w-6xl mx-auto'>
        ...
        >
          ...
          <p className='text-lg text-slate-300 mb-8 max-w-2xl mx-auto'>
            Join teams at leading companies who are shipping APIs with
            confidence.
          </p>
        ...
        >
          ...
          <div>
            ...
            <p className='text-slate-400 text-sm'>
              The unified platform for API testing, security, and performance
              engineering.
            </p>
          </div>
          ...
          <div>
            ...
            <div className='flex gap-4 mb-6'>
              <a
                href='https://www.youtube.com/@optraflow'
                target='_blank'
              ...
              <a
                href='https://www.linkedin.com/company/optraflow/?viewAsMember=true'
                target='_blank'
                className='text-slate-400 hover:text-slate-100 transition-colors'
                aria-label='LinkedIn'
              >
