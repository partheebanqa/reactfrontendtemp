        ...
        <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden pt-20">
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center min-h-[calc(100vh-80px)]">
                ...
                >
                    ...
                    <div className="flex items-center justify-center mb-5">
                        ...
                        >
                            <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                                <span className='text-black'>✨ 2 Minutes for your first test</span>
                    ...
                    >
                        Engineer API <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Confidence</span> from Development to Deployment
                    </motion.h1>
                    ...
                    >
                        The first unified platform for rapid test creation, security scanning, and intelligent performance engineering.
                    </motion.p>
