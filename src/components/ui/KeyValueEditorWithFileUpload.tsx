...
interface KeyValueEditorWithFileUploadProps {
  ...
  onAdd: () => void;
  onUpdate: (index: number, field: keyof KeyValuePairWithFile, value: string | boolean | File | undefined) => void;
...
const KeyValueEditorWithFileUpload: React.FC<KeyValueEditorWithFileUploadProps> = ({
  items,
  onAdd,
  onUpdate,
  onRemove,
