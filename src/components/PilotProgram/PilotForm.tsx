      ...
      <div className='mx-auto max-w-7xl px-20'>
        <div className='mx-auto max-w-4xl rounded-2xl bg-gradient-to-b from-[#16213e] to-[#0f172a] px-10 py-14 shadow-2xl'>
          ...
          <p className='mb-3 text-lg text-white max-w-2xl'>
            "The pilot program is designed to help teams integrate with
            optraflow and explore the tool."
          </p>
          ...
          <div className='space-y-2 mb-10'>
            <p className='flex items-start gap-2 text-sm text-slate-300'>
              ...
              <span>
                Implement API automation with guidance and confidentially
          ...
          {submitted && (
            <p className='mt-4 text-center text-sm text-green-400'>
              "Thank you for joining our pilot program! Our team will get back
              to you within 5 business days. To speed up your onboarding, you
              can register and begin setting up your User Profile today."
            </p>
          )}
        </div>
      </div>
