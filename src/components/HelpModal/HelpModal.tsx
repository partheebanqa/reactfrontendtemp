...
export function HelpModal({ isOpen, onClose }: HelpModalProps) {
  const [activeSection, setActiveSection] = useState<
    'overview' | 'graphql' | 'grpc' | 'websocket' | 'ai' | 'rest' | 'testing'
  >('overview');
    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          Welcome to API Tester Pro! This comprehensive guide will help you test
          different types of APIs effectively.
        </p>
      </div>
        ...
        <div className='flex items-start'>
          ...
          <div>
            ...
            <p className='text-sm text-blue-700 mt-1'>
              Select a section from the left to learn about testing specific API
              types, or jump to Testing Best Practices for general guidelines.
            </p>
          </div>
        </div>
      </div>
  ...
  const renderREST = () => (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          REST (Representational State Transfer) is the most common API
          architecture. Here's how to test REST APIs effectively.
        </p>
      </div>
      ...
      <div className='space-y-4'>
        <div className='border border-gray-200 rounded-lg p-4'>
          ...
          <div className='grid grid-cols-2 gap-4 text-sm'>
            <div>
              <span className='font-medium text-green-600'>GET</span> - Retrieve
              data
              <br />
              <span className='font-medium text-blue-600'>POST</span> - Create
              new resources
              <br />
              <span className='font-medium text-yellow-600'>PUT</span> - Update
              entire resource
            </div>
            <div>
              <span className='font-medium text-orange-600'>PATCH</span> -
              Partial updates
              <br />
              <span className='font-medium text-red-600'>DELETE</span> - Remove
              resources
              <br />
              <span className='font-medium text-gray-600'>HEAD/OPTIONS</span> -
              Metadata
            </div>
          </div>
        </div>
  ...
  const renderGraphQL = () => (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          GraphQL provides a flexible query language for APIs. Here's how to
          test GraphQL endpoints effectively.
        </p>
      </div>
  ...
  const renderGRPC = () => (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          gRPC is a high-performance RPC framework. Here's how to test gRPC
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
          <div className='flex items-start'>
            ...
            <div>
              ...
              <p className='text-sm text-blue-700 mt-1'>
                gRPC testing in API Tester Pro currently provides simulation
                capabilities. For full gRPC testing, consider using specialized
                tools like grpcurl or BloomRPC alongside this platform.
              </p>
            </div>
          </div>
        </div>
  ...
  const renderWebSocket = () => (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          WebSockets enable real-time, bidirectional communication. Here's how
          to test WebSocket connections effectively.
        </p>
      </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
            <div>
              ...
              <div className='text-gray-600 mb-3'>
                UTF-8 encoded strings (JSON, plain text)
              </div>
          ...
          <div className='space-y-3 text-sm'>
            <div className='bg-blue-50 p-3 rounded'>
              ...
              <div className='text-blue-700'>
                Test successful connections, failed connections, and upgrade
                rejections
              </div>
            </div>
            <div className='bg-green-50 p-3 rounded'>
              ...
              <div className='text-green-700'>
                Send various message types and verify responses
              </div>
            </div>
            <div className='bg-yellow-50 p-3 rounded'>
              ...
              <div className='text-yellow-700'>
                Test network interruptions and malformed messages
              </div>
            </div>
            <div className='bg-purple-50 p-3 rounded'>
              ...
              <div className='text-purple-700'>
                Test high-frequency messages and connection limits
              </div>
            </div>
          </div>
        </div>
  ...
  const renderAI = () => (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          AI APIs provide machine learning capabilities. Here's how to test
          various AI service endpoints effectively.
        </p>
      </div>
          ...
          <div className='flex items-start'>
            ...
            <div>
              <h4 className='font-medium text-red-900'>
                AI API Security & Cost Considerations
              </h4>
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
          <div className='flex items-start'>
            ...
            <div>
              ...
              <ul className='text-sm text-blue-700 mt-1 space-y-1'>
                <li>
                  • Test with edge cases (empty prompts, very long inputs)
                </li>
  ...
  const renderTesting = () => (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-4'>
          Follow these comprehensive testing practices to ensure your APIs are
        ...
        <div className='border border-gray-200 rounded-lg p-4'>
          ...
          <div className='space-y-3 text-sm'>
            <div className='bg-blue-50 p-3 rounded'>
              ...
              <div className='text-blue-700'>
                Use realistic, anonymized data that covers edge cases and
                boundary conditions
              </div>
            </div>
            <div className='bg-green-50 p-3 rounded'>
              ...
              <div className='text-green-700'>
                Ensure tests don't interfere with each other by using separate
                test databases
              </div>
            </div>
            <div className='bg-yellow-50 p-3 rounded'>
              ...
              <div className='text-yellow-700'>
                Clean up test data after each test run to maintain consistency
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='border border-gray-200 rounded-lg p-4'>
          ...
          <div className='space-y-3 text-sm'>
            <div className='bg-purple-50 p-3 rounded'>
              ...
              <div className='text-purple-700'>
                Run tests automatically on code changes, deployments, and
                schedules
              </div>
            </div>
            <div className='bg-orange-50 p-3 rounded'>
              ...
              <div className='text-orange-700'>
                Monitor API health, performance, and error rates in production
              </div>
            </div>
            <div className='bg-pink-50 p-3 rounded'>
              ...
              <div className='text-pink-700'>
                Generate detailed test reports and track metrics over time
              </div>
            </div>
          </div>
        </div>
