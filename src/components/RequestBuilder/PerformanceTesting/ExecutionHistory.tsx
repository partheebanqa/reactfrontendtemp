  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Execution History</CardTitle>
        <CardDescription>
          Last {history.length} execution results
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ScrollArea className='h-[600px] pr-4'>
          <div className='space-y-4'>
            {history.map((execution) => {
              ...
              const successRate = (
                (execution.successfulRequests / execution.totalRequests) *
                100
              ).toFixed(1);
                  ...
                  <CardContent className='space-y-3'>
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-3'>
                      <div className='space-y-1'>
                        ...
                        <div className='text-sm font-medium'>
                          {execution.totalRequests.toLocaleString()}
                        </div>
                      </div>
                      <div className='space-y-1'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-3 pt-2 border-t'>
                      <div className='space-y-1'>
                        ...
                        <div className='text-sm font-medium'>
                          {execution.averageResponseTime}ms
                        </div>
                      </div>
                      <div className='space-y-1'>
                        <div className='text-xs text-muted-foreground'>
                    ...
                    <div className='pt-2 border-t'>
                      <div className='text-xs text-muted-foreground'>
                        Duration:{' '}
                        {format(new Date(execution.startTime), 'HH:mm:ss')} -{' '}
