...
const PrimarySchemaPanel: React.FC = () => {
  ...
  return (
    <div className='space-y-4 p-4 rounded-lg border border-gray-200'>
      ...
      <div className='max-h-[calc(100vh-300px)] overflow-auto scrollbar-thin rounded border border-gray-100 p-2'>
          ...
          {hasDifferences ? (
            <div>
              <p className='text-sm text-gray-600 mb-3'>
                ...
                {primarySchemaValidation.differences.length !== 1
                  ? 's'
                  : ''}{' '}
                found
              </p>
              <div className='space-y-3 max-h-60 overflow-y-auto scrollbar-thin pr-1 custom-scrollbar'>
