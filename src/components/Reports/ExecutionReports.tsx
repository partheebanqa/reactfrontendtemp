        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-muted-foreground text-lg'>
              View comprehensive reports for test suite and request chain
              executions
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-8 mb-12 '>
            ...
            <Card className='p-6'>
              <CardHeader className='text-center pb-6'>
                ...
                <p className='text-muted-foreground leading-relaxed'>
                  Detailed analysis of test execution with categorized results,
            ...
            <Card className='p-6'>
              <CardHeader className='text-center pb-6'>
                ...
                <p className='text-muted-foreground leading-relaxed'>
                  Step-by-step execution flow with variable extraction, data
                  flow visualization, and error tracking.
                </p>
              </CardHeader>
          ...
          <div className='text-center'>
            <p className='text-muted-foreground'>
              Reports include environment details, execution timestamps,
              downloadable PDFs, and shareable links.
            </p>
          </div>
        </div>
      </main>
