              ...
              <div className="flex justify-between items-start flex-col md:flex-row">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
                    ...
                    <Globe className="h-4 w-4 mr-2" />
                      Environment: <span className="font-medium ml-1">{meta.environment}</span>
                    </div>
                    <div className="flex items-center">
                      <Calendar className="h-4 w-4 mr-2" />
                      Executed: <span className="font-medium ml-1">{meta.executedAt}</span>
                    </div>
                    <div className="flex items-center">
                      <Clock className="h-4 w-4 mr-2" />
                      Duration: <span className="font-medium ml-1">{meta.duration}</span>
                    </div>
                    <div className="flex items-center">
                      <User className="h-4 w-4 mr-2" />
                      By: <span className="font-medium ml-1">{meta.executedBy}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 md:mt-0 md:ml-6">
                  <div className="bg-yellow-100 rounded-lg p-3 text-center w-28">
                    <div className="text-xl font-bold text-yellow-700">{successRate}</div>
                    <div className="text-xs text-yellow-700 font-medium">Success Rate</div>
                  </div>
                </div>
              </div>
            </CardContent>
