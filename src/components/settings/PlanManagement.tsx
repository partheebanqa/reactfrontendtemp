...
export function PlanManagement() {
  ...
  const currentSubscriptionNew = Array.isArray(plansData)
    ? plansData.find((plan) => plan.ID === currentPlan?.PlanID)
    : undefined;

  const subscription = currentSubscriptionNew || {
    Price: 0,
    BillingCycle: 'month',
  };
                    ...
                    <div className='bg-yellow-50 border border-yellow-200 rounded-md p-4'>
                      ...
                      <ul className='mt-2 text-sm text-yellow-700 space-y-1'>
                        <li>
                          ...
                          {formatDate(currentSubscription.billingDate)}
                        </li>
                        <li>
                          • You'll lose access to pro features after the current
                          billing period
                        </li>
                        <li>• Your data will be preserved for 30 days</li>
                        <li>
                          • You can reactivate anytime before data deletion
                        </li>
                      </ul>
                    </div>
              ...
              plansData.map((plan) => (
                ...
                >
                  ...
                  <div className='text-center mb-4 sm:mb-6'>
                    ...
                    <p className='text-xs sm:text-[11px] text-gray-600 dark:text-gray-400'>
                      {plan.Description}
                    </p>
                  </div>
