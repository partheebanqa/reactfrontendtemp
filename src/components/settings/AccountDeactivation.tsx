...
const deactivationSchema = z.object({
  ...
  confirmations: z.object({
    dataLoss: z
      .boolean()
      .refine((val) => val === true, 'You must acknowledge data loss'),
    subscriptionCancellation: z
      .boolean()
      .refine(
        (val) => val === true,
        'You must acknowledge subscription cancellation'
      ),
    irreversible: z
      .boolean()
      .refine(
        (val) => val === true,
        'You must acknowledge this action is irreversible'
      ),
  }),
});
          ...
          <div className='flex items-start gap-3'>
            ...
            <div>
              ...
              <div className='text-sm text-red-700 mt-1 space-y-1'>
                <p>
                  • All your API tests, schedules, and execution history will be
                  affected
                </p>
                <p>• Your subscription will be immediately cancelled</p>
                <p>• Team members will lose access to shared workspaces</p>
                <p>
                  • This action may not be reversible depending on your data
                  retention choice
                </p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-3 text-sm'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Switch to a lower tier to reduce costs while keeping your data
                </p>
              </div>
            </div>
            <div className='flex items-start gap-3 text-sm'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Temporarily suspend billing while preserving your account
                </p>
              </div>
            </div>
          </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <div className='space-y-3'>
                            {Object.entries(dataHandlingLabels).map(
                              ([value, label]) => (
                                <div
                                  key={value}
                          ...
                          <FormItem className='flex flex-row items-start space-x-3 space-y-0'>
                            ...
                            <div className='space-y-1 leading-none'>
                              <FormLabel className='text-sm'>
                                I understand that I will lose access to all my
                                data
                              </FormLabel>
                            </div>
                          </FormItem>
