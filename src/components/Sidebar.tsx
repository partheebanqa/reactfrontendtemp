...
import { X, LayoutDashboard, Layers, BarChart, PlusCircle } from 'lucide-react';
    ...
    <>
      <aside
        className={`hidden md:flex ${
          collapsed ? 'w-16' : 'w-64'
        } bg-white shadow-lg flex-col border-r transition-all duration-300 h-full`}
      >
        {/* Logo Section */}
        <div
          className={`${
        ...
        {/* Content area split into nav + help */}
