        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Import or add APIs to test. Select which ones require authentication.
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => setNewAPI({ ...newAPI, requires_auth: e.target.checked })}
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                />
                <label htmlFor="requires-auth" className="text-sm text-gray-700">
          ...
          <>
            <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                ...
                <span className="font-semibold">{apis.length}</span> APIs selected for testing
              </p>
            </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 break-all">{api.url}</p>
                        </div>
                        <button
