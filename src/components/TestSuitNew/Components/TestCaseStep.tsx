        ...
        {testCases.length === 0 ? (
          <div className='text-center py-12'>
            ...
            <p className='text-sm text-gray-600 mb-4 max-w-md mx-auto'>
              Click the "Generate Test Cases" button to automatically create
              comprehensive test cases for your selected APIs.
            </p>
            {selectedAPIs.length === 0 && (
              <p className='text-sm text-yellow-700 bg-yellow-50 border border-yellow-200 rounded-lg p-3 max-w-md mx-auto'>
                Please select at least one API in the previous step before
                generating tests.
              </p>
            )}
          </div>
          ...
          <>
            <div className='mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg'>
              <p className='text-sm text-blue-800'>
                ...
                <span className='font-semibold'>{testCases.length}</span> test
                cases selected
              </p>
            </div>
