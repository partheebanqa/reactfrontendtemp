                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-sm text-blue-700'>
                      Start your 15-day free trial and unlock all Pro features
                      instantly.
                    </p>
                  </div>
                  <Button
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-sm text-yellow-700'>
                      Your trial expires in {trialDaysLeft} days. Upgrade now to
