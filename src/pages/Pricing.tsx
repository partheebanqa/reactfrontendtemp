        ...
        <div className='container mx-auto px-4 pt-16 pb-8'>
          <div className='text-center mb-8'>
            ...
            <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
              Start with our free plan and upgrade as your API testing needs
              grow. All plans include our core testing features.
            </p>
          </div>
          ...
          <div className='mb-16'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
              ...
              <div>
                ...
                <p className='text-muted-foreground text-sm'>
                  Yes! All paid plans come with a 15-day free trial. No credit
              ...
              <div>
                ...
                <p className='text-muted-foreground text-sm'>
                  Your data is retained for 30 days after cancellation, giving
                  you time to export it or reactivate your account.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* <div className='text-center bg-primary rounded-2xl p-12 text-primary-foreground'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              ...
              <Button
                ...
                variant='secondary'
                onClick={() =>
                  (window.location.href = 'mailto:sales@apiflow.com')
                }
              >
