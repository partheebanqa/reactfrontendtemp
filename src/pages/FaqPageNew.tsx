...
const faqData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'No coding skills required. Optraflow is designed for both developers and non‑technical team members.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          'Does Optraflow integrate with Jira, Slack, or Microsoft Teams?',
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          'Does Optraflow handle security, load, or performance testing?',
        answer:
...
const AccordionItem: React.FC<{ q: string; a: string }> = ({ q, a }) => {
  ...
  return (
    ...
    >
      ...
      {open && <p className='mt-3 text-gray-700 whitespace-pre-line'>{a}</p>}
    </div>
  );
};
