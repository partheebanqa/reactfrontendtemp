  ...
  const mockIntegrations: CiCdIntegration[] = [
    {
      ...
      config: {
        ...
        username: 'api-user',
        webhookUrl:
          'https://jenkins.company.com/buildByToken/build?job=api-tests',
      },
      isActive: true,
    ...
    },
    {
      ...
      config: {
        ...
        webhookUrl:
          'https://api.github.com/repos/company/frontend-app/dispatches',
      },
      isActive: true,
        ...
        <div className='flex items-center justify-between'>
          <div>
            ...
            <p className='text-muted-foreground mt-1'>
              Connect your development pipeline to automatically trigger API
              tests
            </p>
          </div>
              ...
              <div className='space-y-6'>
                ...
                <div className='flex justify-end space-x-2'>
                  ...
                  <Button
                    ...
                    disabled={
                      !newIntegration.name.trim() ||
                      !newIntegration.token.trim() ||
                  ...
                  <div>
                    ...
                    <p className='text-2xl font-bold'>
                      {allIntegrations.reduce(
                        (acc, integration) =>
                          acc + (integration.triggerCount || 0),
                        0,
                      )}
                    </p>
                  </div>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-2xl font-bold text-blue-600'>
                      {
                        allIntegrations.filter((i) => i.status === 'connected')
                          .length
                      }
                    </p>
                  </div>
                        ...
                        <div className='space-y-2'>
                          {integration.config.serverUrl && (
                            <div className='flex items-center space-x-2 text-sm text-muted-foreground'>
                              <span>
                                Server: {integration.config.serverUrl}
                              </span>
                          ...
                          {integration.config.webhookUrl && (
                            <div className='flex items-center space-x-2 text-sm'>
                              ...
                              <Button
                                ...
                                size='sm'
                                onClick={() =>
                                  copyWebhookUrl(integration.config.webhookUrl!)
                                }
                              >
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground'>
                Integrate OPTRAFLOW with your development pipeline to
                automatically run API tests when code changes, ensuring your
                APIs work correctly in every deployment.
              </p>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='p-4 border rounded-lg'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Trigger API tests automatically on pull requests and
                    deployments
                  </p>
                </div>
