...
export default function AccountSettings() {
  ...
  useEffect(() => {
    ...
    if (
      tabFromURL &&
      settingsSections.some((section) => section.id === tabFromURL)
    ) {
    ...
    <div className='flex-1 bg-gray-50 h-full'>
      ...
      <div className='bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white mb-3'>
        ...
        <p className='opacity-90'>
          Welcome to your account settings. Here you can manage your login
          information and security preferences.
        </p>
      </div>
                  ...
                  {settingsSections.map((section) => {
                    ...
                    return (
                      <button
                        key={section.id}
                        onClick={() =>
                          !section.upcoming && handleTabChange(section.id)
                        }
