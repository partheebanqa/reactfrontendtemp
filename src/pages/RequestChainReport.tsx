...
const globalVars = {
  baseUrl: "https://api.staging.ecommerce.com",
...
const extractedVars = {
  ...
  orderId: "order_321ghi",
  paymentIntentId: "pi_987jk1",
  totalAmount: "29.99",
};
...
const steps = [
  ...
  },
  {
    ...
    status: "success" as const,
    extractedVars: [
      { key: "paymentIntentId", value: "pi_987jkl" },
      { key: "clientSecret", value: "pi_987jkl_secret_abc" },
    ],
  },
  {
    step: 5,
    ...
    url: "/api/payments/pi_987jkl/confirm",
    statusCode: 402,
    ...
    extractedVars: [],
    errorMessage:
      "Payment declined - Insufficient funds on card ending in 4242",
  },
  {
    step: 6,
    method: "POST",
    ...
    status: "success" as const,
    extractedVars: [
      { key: "orderId", value: "order_321ghi" },
      { key: "orderStatus", value: "pending_payment" },
    ],
  },
];
  ...
  return (
    <div className="px-1 py-1">
      ...
      <AnalyticsReport
        ...
        description="Complete user journey from product selection to order confirmation including cart management, payment processing, and order creation."
        successRate="83%"
        meta={{
          environment: "Staging",
...
export default RequestChainReport;
