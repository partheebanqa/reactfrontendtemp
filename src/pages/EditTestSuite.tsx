...
const EditTestSuite: React.FC = () => {
  ...
  const [testSuiteName, setTestSuiteName] = useState('test123');
          ...
          <CardContent>
            <div className='mb-4 p-3 bg-blue-50 rounded-md'>
              <div className='flex justify-between text-sm'>
                <span className='text-blue-700'>2 requests configured</span>
                <span className='text-blue-700'>13 test cases selected</span>
              </div>
            </div>
            ...
            <div className='mt-6 pt-4 border-t bg-gray-50 -mx-4 px-4 py-3 rounded-b-lg'>
              <div className='flex justify-between text-sm'>
                <span>
                  Configured requests: <strong>2</strong>
                </span>
                <span>
