const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pdf-utils-B5L7NxEK.js","assets/vendor-C8XADQr8.js","assets/vendor-Cd6H9538.css"])))=>i.map(i=>d[i]);
import{j as e,be as Pe,bf as Ie,r as w,aX as Ae,R as ne}from"./vendor-C8XADQr8.js";import{a as Ne,u as ke}from"./router-DXeCv1r4.js";import{b as Le}from"./tanstack-BIfAXR0U.js";import{a as G,e as ce}from"./exportDate-BquIzF1Z.js";import{R as Ue,V as Be}from"./VariablesAndDataFlow-DY4mKuz4.js";import{E as Oe,_ as xe}from"./pdf-utils-B5L7NxEK.js";import{m as Y,C as me,i as D,g as J,a5 as V,ar as le,af as X,n as pe,h as Q,T as oe,W,V as _,bD as ue,aj as Te,_ as $e,aD as ge,X as qe,at as _e,aa as He,x as Ce,ay as Re,aT as Se,bE as Je}from"./icons-R8qAh6_9.js";import{L as Ee}from"./OptraLogo-Cw5cE5z2.js";import{k as ee,q as se,T as I,f as A,g as L,h as Ve}from"./index-BEAOFguE.js";import{u as te}from"./useWorkspace-BU9iv6Gn.js";import{g as de,n as Ge}from"./integrationTools.service-MM9WqUQ7.js";import{I as Ke}from"./input-B2VkJwH9.js";import{T as Ze}from"./textarea-Bxz5FciO.js";import{B as re}from"./button-BSdDwvkz.js";import"./badge-OSaJqKXb.js";import"./radix-ui-DZ7Goqhl.js";import"./tabs-CiQz6NYH.js";import"./select-ClE5f9gt.js";import"./card-LScUMDG4.js";import"./collectionStore-DbZlShTx.js";const Me=(s,t)=>{const i=`${window.location.origin}/executions/report/test_suite/${s}?executionId=${t}`;navigator.share?navigator.share({title:"Test Suite Report",text:"View this comprehensive API test suite report",url:i}).catch(console.error):navigator.clipboard?navigator.clipboard.writeText(i).then(()=>alert("Shareable link copied to clipboard!")).catch(()=>prompt("Copy this shareable link:",i)):prompt("Copy this shareable link:",i)},q=({code:s,language:t="json",className:i})=>e.jsx("div",{className:i,children:e.jsx(Pe,{language:t,style:Ie,customStyle:{borderRadius:8,margin:0,fontSize:12.5,lineHeight:1.6,padding:"12px 14px"},wrapLongLines:!0,showLineNumbers:!1,children:s})}),he=s=>{if(!s)return"";let t=s.trim();return/^curl\b/.test(t)||(t="curl "+t),t=t.replace(/\s-X\s'([^']+)'/g,` \\
  -X $1`),t=t.replace(/\s-H\s'([^']+)'/g,` \\
  -H "$1"`),t=t.replace(/\s(--data-raw|-d)\s'([^']+)'/g,(i,a,x)=>{let c=x;try{const r=JSON.parse(x);c=JSON.stringify(r,null,2)}catch{}const n=c.replace(/'/g,"'\\''");return` \\
  ${a} '${n}'`}),t=t.replace(/\s'(https?:\/\/[^']+)'/g,` \\
  "$1"`),t=t.replace(/[ \t]+/g," "),t},fe=s=>{switch(s){case"passed":return"bg-green-100 text-green-800 border-green-200";case"failed":return"bg-red-100 text-red-800 border-red-200";case"skipped":return"bg-yellow-100 text-yellow-800 border-yellow-200";default:return"bg-gray-100 text-gray-800 border-gray-200"}},be=s=>{switch(s){case"critical":return"bg-red-600 text-white";case"high":return"bg-orange-600 text-white";case"medium":return"bg-yellow-600 text-white";case"low":return"bg-blue-600 text-white";default:return"bg-gray-600 text-white"}},ve=s=>{try{const t=JSON.parse(s);return JSON.stringify(t,null,2)}catch{return s}},Ye=s=>{try{const t=JSON.parse(s);return(t==null?void 0:t.statusCode)!=null?String(t.statusCode):null}catch{return null}},Xe=s=>{var x,c;const t=((x=s.expectedResponse)==null?void 0:x.status)!=null?String(s.expectedResponse.status):null,i=Ye(s.response??"");if(s.status!=="failed")return{message:"",expected:t,actual:i};const a=((c=s.errorMessage)==null?void 0:c.trim())??"";return a?{message:a,expected:t,actual:i}:t!==null&&i!==null?{message:`Expected status ${t}, but got ${i}`,expected:t,actual:i}:{message:"N/A",expected:null,actual:null}},ye=({testCase:s})=>{const{status:t}=s,{message:i,expected:a,actual:x}=Xe(s);if(!(i||a!=null&&x!=null))return null;const n=t==="failed",r=t==="passed",l=n?"border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950/30":r?"border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/30":"border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950/30",d=n?"border-red-200 dark:border-red-800":r?"border-green-200 dark:border-green-800":"border-yellow-200 dark:border-yellow-800",m=n?"text-red-600 dark:text-red-400":r?"text-green-600 dark:text-green-400":"text-yellow-600 dark:text-yellow-400",g=n?"text-red-700 dark:text-red-400":r?"text-green-700 dark:text-green-400":"text-yellow-700 dark:text-yellow-400",p=n?"text-red-800 dark:text-red-300":r?"text-green-800 dark:text-green-300":"text-yellow-800 dark:text-yellow-300",o=n?"Failure Reason":r?"Status Check":"Test Summary",u=n?V:le,b="bg-green-100 text-green-800 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-700",$=n?"bg-red-100 text-red-800 border-red-200 dark:bg-red-900/40 dark:text-red-300 dark:border-red-700":"bg-green-100 text-green-800 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-700";return e.jsxs("div",{className:`mb-4 rounded-lg border overflow-hidden ${l}`,children:[e.jsxs("div",{className:`flex items-center gap-2 px-4 py-2.5 border-b ${d}`,children:[e.jsx(u,{className:`w-4 h-4 flex-shrink-0 ${m}`}),e.jsx("span",{className:`text-xs font-semibold uppercase tracking-wider ${g}`,children:o})]}),e.jsxs("div",{className:"px-4 py-3 space-y-3",children:[i&&e.jsx("p",{className:`text-sm font-medium break-words ${p}`,children:i}),a!=null&&x!=null&&e.jsxs("div",{className:"flex flex-wrap items-center gap-2 text-xs font-medium",children:[e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsx("span",{className:"w-2 h-2 rounded-full bg-green-500 flex-shrink-0"}),e.jsx("span",{className:"text-gray-600 dark:text-gray-400",children:"Expected"}),e.jsx("span",{className:`inline-flex items-center px-2 py-0.5 rounded border font-semibold ${b}`,children:a})]}),e.jsx("span",{className:"text-gray-400 dark:text-gray-500",children:"→"}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsx("span",{className:`w-2 h-2 rounded-full flex-shrink-0 ${n?"bg-red-500":"bg-green-500"}`}),e.jsx("span",{className:"text-gray-600 dark:text-gray-400",children:"Actual"}),e.jsx("span",{className:`inline-flex items-center px-2 py-0.5 rounded border font-semibold ${$}`,children:x})]})]})]})]})},je=({testCase:s})=>{const[t,i]=w.useState(!1),a=e.jsxs("div",{className:"hidden md:block border border-gray-200 dark:border-gray-700 rounded-lg mb-4 overflow-hidden",children:[e.jsx("div",{className:"p-4 bg-gray-50 dark:bg-gray-800/40 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",onClick:()=>i(!t),children:e.jsxs("div",{className:"flex items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex items-start gap-3 min-w-0",children:[t?e.jsx(Y,{className:"w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0"}):e.jsx(me,{className:"w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0"}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("h3",{className:"font-semibold text-gray-900 dark:text-white truncate",children:s.name}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 mt-1",children:[e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${fe(s.status)}`,children:s.status.toUpperCase()}),e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded text-xs font-medium ${be(s.severity)}`,children:s.severity.toUpperCase()})]})]})]}),e.jsxs("div",{className:"flex items-center gap-5 text-sm text-gray-500 flex-shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(D,{className:"w-4 h-4"}),e.jsxs("span",{children:[s.duration,"ms"]})]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(J,{className:"w-4 h-4"}),e.jsxs("span",{children:[s.responseSize,"B"]})]})]})]})}),t&&e.jsx("div",{className:"p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900",children:e.jsxs("div",{className:"space-y-4",children:[e.jsx(ye,{testCase:s}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium text-gray-900 dark:text-white mb-2",children:"Endpoint"}),e.jsx(q,{language:"http",code:`${s.method.toUpperCase()} ${s.url}`})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium text-gray-900 dark:text-white mb-2",children:"Request cURL"}),e.jsx(q,{language:"bash",code:he(s.requestCurl)})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium text-gray-900 dark:text-white mb-2",children:"Response"}),e.jsx(q,{language:"json",code:ve(s.response)})]})]})})]}),x=e.jsxs("div",{className:"block md:hidden border border-gray-200 dark:border-gray-800 rounded-xl mb-4 overflow-hidden bg-white dark:bg-gray-900",children:[e.jsx("div",{className:"p-4 cursor-pointer bg-gray-50 dark:bg-gray-800/40 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",onClick:()=>i(!t),children:e.jsxs("div",{className:"flex items-start gap-3",children:[t?e.jsx(Y,{className:"w-5 h-5 text-gray-400 mt-1 flex-shrink-0"}):e.jsx(me,{className:"w-5 h-5 text-gray-400 mt-1 flex-shrink-0"}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("h3",{className:"text-sm sm:text-base font-semibold text-gray-900 dark:text-white truncate",children:s.name}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2 mt-2",children:[e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${fe(s.status)}`,children:s.status.toUpperCase()}),e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded text-xs font-medium ${be(s.severity)}`,children:s.severity.toUpperCase()})]}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 sm:flex sm:items-center sm:gap-6 gap-3 text-xs sm:text-sm text-gray-500",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(D,{className:"w-4 h-4"}),e.jsxs("span",{children:[s.duration,"ms"]})]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(J,{className:"w-4 h-4"}),e.jsxs("span",{children:[s.responseSize,"B"]})]})]})]})]})}),t&&e.jsxs("div",{className:"p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 space-y-5",children:[e.jsx(ye,{testCase:s}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-sm font-semibold text-gray-900 dark:text-white mb-2",children:"Endpoint"}),e.jsx(q,{language:"http",code:`${s.method.toUpperCase()} ${s.url}`})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-sm font-semibold text-gray-900 dark:text-white mb-2",children:"Request cURL"}),e.jsx(q,{language:"bash",code:he(s.requestCurl)})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-sm font-semibold text-gray-900 dark:text-white mb-2",children:"Response"}),e.jsx(q,{language:"json",code:ve(s.response)})]})]})]});return e.jsxs(e.Fragment,{children:[a,x]})},Qe=s=>{var a;if(!s)return[];const t=["positiveTests","negativeTests","functionalTests","semanticTests","edgeCaseTests","securityTests","advancedSecurityTests"],i=[];for(const x of s.requests||[])for(const c of t){const n=x[c];if((a=n==null?void 0:n.testCases)!=null&&a.length)for(const r of n.testCases)i.push({...r,method:r.method||x.method,url:r.url||x.url})}return i},We=s=>{try{const t=new URL(s),i=`${t.protocol}//${t.host.toLowerCase()}`,a=t.pathname.replace(/\/$/,"");return`${i}${a}${t.search}`}catch{return s.trim().replace(/\/$/,"")}},we=s=>{switch((s||"").toUpperCase()){case"GET":return"bg-blue-100 text-blue-800 border-blue-200";case"POST":return"bg-green-100 text-green-800 border-green-200";case"PUT":return"bg-yellow-100 text-yellow-800 border-yellow-200";case"DELETE":return"bg-red-100 text-red-800 border-red-200";case"PATCH":return"bg-purple-100 text-purple-800 border-purple-200";case"OPTIONS":return"bg-gray-100 text-gray-800 border-gray-200";default:return"bg-gray-100 text-gray-800 border-gray-200"}},es=({report:s,testCases:t})=>{const[i,a]=w.useState(new Set),x=w.useMemo(()=>t&&t.length?t:Qe(s),[s,t]),c=w.useMemo(()=>{const d={};for(const m of x){const g=We(m.url||"");d[g]||(d[g]={key:g,endpoint:m.url,methods:{},total:0,passed:0,failed:0,skipped:0,avgDuration:0});const p=d[g],o=(m.method||"").toUpperCase();p.methods[o]||(p.methods[o]={method:o,testCases:[],total:0,passed:0,failed:0,skipped:0,avgDuration:0});const u=p.methods[o];u.testCases.push(m),u.total+=1,m.status==="passed"?u.passed+=1:m.status==="failed"?u.failed+=1:m.status==="skipped"&&(u.skipped+=1),p.total+=1,m.status==="passed"?p.passed+=1:m.status==="failed"?p.failed+=1:m.status==="skipped"&&(p.skipped+=1)}return Object.values(d).forEach(m=>{Object.values(m.methods).forEach(p=>{const o=p.testCases.reduce((u,b)=>u+(b.duration||0),0);p.avgDuration=p.total?Math.round(o/p.total):0});const g=Object.values(m.methods).flatMap(p=>p.testCases).reduce((p,o)=>p+(o.duration||0),0);m.avgDuration=m.total?Math.round(g/m.total):0}),d},[x]),n=Object.values(c),r=d=>{const m=new Set(i);m.has(d)?m.delete(d):m.add(d),a(m)},l=(d,m)=>m?Math.round(d/m*100):0;return n.length?e.jsx("div",{className:"space-y-4",children:e.jsxs("div",{className:"bg-white rounded-lg border border-gray-200 p-3 md:p-6",children:[e.jsxs("h2",{className:"text-md md:text-xl font-bold text-gray-900 mb-4 flex items-center",children:[e.jsx(X,{className:"w-6 h-6 mr-2 text-blue-600"}),"API Endpoints (",n.length," endpoints)"]}),e.jsx("div",{className:"space-y-4 hidden md:block",children:n.map(d=>{const m=i.has(d.key),g=l(d.passed,d.total);return e.jsxs("div",{className:"border border-gray-200 rounded-lg overflow-hidden",children:[e.jsx("div",{className:"p-4 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors",onClick:()=>r(d.key),children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center space-x-4 flex-1",children:[m?e.jsx(Y,{className:"w-5 h-5 text-gray-400"}):e.jsx(pe,{className:"w-5 h-5 text-gray-400"}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-xs md:text-lg font-medium text-gray-900",title:d.endpoint,children:d.endpoint}),e.jsxs("p",{className:"text-sm text-gray-500",children:[d.total," test case",d.total===1?"":"s"]})]})]}),e.jsxs("div",{className:"flex items-center space-x-6 text-sm",children:[e.jsxs("div",{className:"flex items-center space-x-1 text-green-600",children:[e.jsx(Q,{className:"w-4 h-4"}),e.jsx("span",{children:d.passed})]}),e.jsxs("div",{className:"flex items-center space-x-1 text-red-600",children:[e.jsx(V,{className:"w-4 h-4"}),e.jsx("span",{children:d.failed})]}),d.skipped>0&&e.jsxs("div",{className:"flex items-center space-x-1 text-yellow-600",children:[e.jsx(oe,{className:"w-4 h-4"}),e.jsx("span",{children:d.skipped})]}),e.jsxs("div",{className:"flex items-center space-x-1 text-gray-500",children:[e.jsx(D,{className:"w-4 h-4"}),e.jsxs("span",{children:[d.avgDuration,"ms avg"]})]}),e.jsxs("div",{className:`font-semibold ${g>=80?"text-green-600":g>=60?"text-yellow-600":"text-red-600"}`,children:[g,"%"]})]})]})}),m&&e.jsx("div",{className:"border-t border-gray-200 bg-white",children:e.jsx("div",{className:"p-4 space-y-6",children:Object.values(d.methods).map(p=>e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:"flex items-center gap-3",children:e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded text-xs font-medium border ${we(p.method)}`,children:p.method})}),e.jsx("div",{className:"space-y-3",children:p.testCases.map(o=>e.jsx(je,{testCase:o},o.id))})]},p.method))})})]},d.key)})}),e.jsx("div",{className:"space-y-4 block md:hidden",children:n.map(d=>{const m=i.has(d.key),g=l(d.passed,d.total);return e.jsxs("div",{className:"border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden bg-white dark:bg-gray-900",children:[e.jsxs("div",{className:"p-4 cursor-pointer bg-gray-50 dark:bg-gray-800/40 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",onClick:()=>r(d.key),children:[e.jsxs("div",{className:"flex items-start gap-3",children:[m?e.jsx(Y,{className:"w-5 h-5 text-gray-400 mt-1 flex-shrink-0"}):e.jsx(pe,{className:"w-5 h-5 text-gray-400 mt-1 flex-shrink-0"}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-sm sm:text-base font-semibold text-gray-900 dark:text-white truncate",title:d.endpoint,children:d.endpoint}),e.jsxs("p",{className:"text-xs text-gray-500 mt-1",children:[d.total," test case",d.total===1?"":"s"]})]})]}),e.jsxs("div",{className:"mt-4 grid grid-cols-2 sm:grid-cols-3 md:flex md:items-center md:justify-between gap-3 text-xs sm:text-sm",children:[e.jsxs("div",{className:"flex items-center gap-1 text-green-600",children:[e.jsx(Q,{className:"w-4 h-4"}),e.jsxs("span",{children:[d.passed," Passed"]})]}),e.jsxs("div",{className:"flex items-center gap-1 text-red-600",children:[e.jsx(V,{className:"w-4 h-4"}),e.jsxs("span",{children:[d.failed," Failed"]})]}),d.skipped>0&&e.jsxs("div",{className:"flex items-center gap-1 text-yellow-600",children:[e.jsx(oe,{className:"w-4 h-4"}),e.jsxs("span",{children:[d.skipped," Skipped"]})]}),e.jsxs("div",{className:"flex items-center gap-1 text-gray-500",children:[e.jsx(D,{className:"w-4 h-4"}),e.jsxs("span",{children:[d.avgDuration,"ms avg"]})]}),e.jsxs("div",{className:`font-semibold ${g>=80?"text-green-600":g>=60?"text-yellow-600":"text-red-600"}`,children:[g,"% Success"]})]})]}),m&&e.jsx("div",{className:"border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900",children:e.jsx("div",{className:"p-4 space-y-6",children:Object.values(d.methods).map(p=>e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center gap-3 flex-wrap",children:[e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded text-xs font-medium border ${we(p.method)}`,children:p.method}),e.jsxs("span",{className:"text-xs text-gray-500",children:[p.total," cases • ",p.avgDuration,"ms avg"]})]}),e.jsx("div",{className:"space-y-3",children:p.testCases.map(o=>e.jsx(je,{testCase:o},o.id))})]},p.method))})})]},d.key)})})]})}):e.jsxs("div",{className:"bg-white rounded-lg border border-gray-200 p-8 text-center",children:[e.jsx(X,{className:"w-12 h-12 text-gray-400 mx-auto mb-4"}),e.jsx("p",{className:"text-gray-500",children:"No API requests found"})]})},ss=(s,t,i={})=>{const a=window.__REPORT_DATA__;if(!a){alert("Report data not available for export");return}const x=js(a,s,{codeTheme:i.codeTheme??"dark"}),c=new Blob([x],{type:"text/html"}),n=URL.createObjectURL(c),r=document.createElement("a");r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)},S=s=>String(s??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;"),ts=s=>{if(s==null)return"";if(typeof s=="object")try{return JSON.stringify(s,null,2)}catch{return String(s)}try{return JSON.stringify(JSON.parse(String(s)),null,2)}catch{return String(s)}},as=s=>`${((s??0)/1e3).toFixed(2)}s`,rs=s=>{if(!s)return"0 B";const t=1024,i=["B","KB","MB","GB"],a=Math.floor(Math.log(s)/Math.log(t));return`${parseFloat((s/Math.pow(t,a)).toFixed(2))} ${i[a]}`},Fe=s=>{const t={GET:"bg-blue-100 text-blue-800 border-blue-200",POST:"bg-green-100 text-green-800 border-green-200",PUT:"bg-yellow-100 text-yellow-800 border-yellow-200",DELETE:"bg-red-100 text-red-800 border-red-200",PATCH:"bg-purple-100 text-purple-800 border-purple-200",OPTIONS:"bg-gray-100 text-gray-800 border-gray-200"};return t[(s||"").toUpperCase()]||t.OPTIONS},is=s=>({passed:"bg-green-100 text-green-800 border-green-200",failed:"bg-red-100 text-red-800 border-red-200",skipped:"bg-yellow-100 text-yellow-800 border-yellow-200"})[s]||"bg-gray-100 text-gray-800 border-gray-200",ns=s=>({critical:"bg-red-600 text-white",high:"bg-orange-600 text-white",medium:"bg-yellow-600 text-white",low:"bg-blue-600 text-white"})[s]||"bg-gray-600 text-white",ze=s=>{try{const t=new URL(s),i=`${t.protocol}//${t.host.toLowerCase()}`,a=t.pathname.replace(/\/$/,"");return`${i}${a}${t.search}`}catch{return(s||"").trim().replace(/\/$/,"")}},ls=s=>{if(s==null)return null;if(typeof s=="object")return(s==null?void 0:s.statusCode)!=null?String(s.statusCode):null;try{const t=JSON.parse(s);return(t==null?void 0:t.statusCode)!=null?String(t.statusCode):null}catch{return null}},os=s=>{var x;const t=((x=s.expectedResponse)==null?void 0:x.status)!=null?String(s.expectedResponse.status):null,i=ls(s.response);if(s.status!=="failed")return{message:"",expected:t,actual:i};const a=(s.errorMessage??"").trim();return a?{message:a,expected:t,actual:i}:t!==null&&i!==null?{message:`Expected status ${t}, but got ${i}`,expected:t,actual:i}:{message:"N/A",expected:null,actual:null}},ds=s=>{const{message:t,expected:i,actual:a}=os(s);if(!(t||i!==null&&a!==null))return"";const c=s.status==="failed",n=s.status==="passed",r=c?"border:1px solid #fecaca;background:#fef2f2;border-radius:8px;margin-bottom:16px;overflow:hidden;":n?"border:1px solid #bbf7d0;background:#f0fdf4;border-radius:8px;margin-bottom:16px;overflow:hidden;":"border:1px solid #fde68a;background:#fefce8;border-radius:8px;margin-bottom:16px;overflow:hidden;",l=c?"#fecaca":n?"#bbf7d0":"#fde68a",d=c?"❌":n?"✅":"⚠️",m=c?"FAILURE REASON":n?"STATUS CHECK":"TEST SUMMARY",g=c?"#991b1b":n?"#166534":"#92400e",p=c?"#991b1b":n?"#166534":"#92400e",E=i!==null&&a!==null?`<div style="display:flex;flex-wrap:wrap;align-items:center;gap:10px;font-size:13px;font-weight:500;">
  ...
  <div style="${r}">
  ...
  </div>`},cs=s=>{var x,c,n,r,l,d,m;const t=[...((x=s.positiveTests)==null?void 0:x.apis)??[],...((c=s.negativeTests)==null?void 0:c.apis)??[],...((n=s.functionalTests)==null?void 0:n.apis)??[],...((r=s.semanticTests)==null?void 0:r.apis)??[],...((l=s.edgeCaseTests)==null?void 0:l.apis)??[],...((d=s.securityTests)==null?void 0:d.apis)??[],...((m=s.advancedSecurityTests)==null?void 0:m.apis)??[]];if(t.length)return t;const i=["positiveTests","negativeTests","functionalTests","semanticTests","edgeCaseTests","securityTests","advancedSecurityTests"],a=[];for(const g of s.requests??[])for(const p of i){const o=g[p];for(const u of(o==null?void 0:o.testCases)??[])a.push({...u,method:u.method||g.method,url:u.url||g.url})}return a},xs=s=>{const t={};for(const i of s){const a=ze(i.url||"");t[a]||(t[a]={key:a,endpoint:i.url,methods:{},total:0,passed:0,failed:0,skipped:0,avgDuration:0});const x=t[a],c=(i.method||"").toUpperCase();x.methods[c]||(x.methods[c]={method:c,testCases:[],total:0,passed:0,failed:0,skipped:0,avgDuration:0});const n=x.methods[c];n.testCases.push(i),n.total++,i.status==="passed"?n.passed++:i.status==="failed"?n.failed++:i.status==="skipped"&&n.skipped++,x.total++,i.status==="passed"?x.passed++:i.status==="failed"?x.failed++:i.status==="skipped"&&x.skipped++}return Object.values(t).forEach(i=>{Object.values(i.methods).forEach(x=>{const c=x.testCases.reduce((n,r)=>n+(r.duration||0),0);x.avgDuration=x.total?Math.round(c/x.total):0});const a=Object.values(i.methods).flatMap(x=>x.testCases).reduce((x,c)=>x+(c.duration||0),0);i.avgDuration=i.total?Math.round(a/i.total):0}),Object.values(t)},ms=(s,t)=>t?Math.round(s/t*100):0,ps=s=>{const t=s.length,i=new Set(s.map(u=>ze(u.url))).size,a=s.map(u=>Number(u.duration||0)).filter(u=>Number.isFinite(u)),x=a.length?Math.min(...a):0,c=a.length?Math.max(...a):0,n=a.length?Math.round(a.reduce((u,b)=>u+b,0)/a.length):0,r=s.reduce((u,b)=>u+Number(b.responseSize||0),0),l={};s.forEach(u=>{const b=(u.method||"").toUpperCase();l[b]=(l[b]||0)+1});const d={};s.forEach(u=>{if(u.statusCode!=null){const b=String(u.statusCode);d[b]=(d[b]||0)+1}});const m={};s.forEach(u=>{if(u.status==="failed"){const b=u.category||"Failed";m[b]=(m[b]||0)+1}});const p=[...s].sort((u,b)=>(b.duration||0)-(u.duration||0)).slice(0,5).map(u=>({id:u.id,name:u.name,method:u.method,url:u.url,duration:u.duration||0})),o=[...s].sort((u,b)=>(u.duration||0)-(b.duration||0)).slice(0,5).map(u=>({id:u.id,name:u.name,method:u.method,url:u.url,duration:u.duration||0}));return{totalRequests:t,uniqueEndpoints:i,averageResponseTime:n,minResponseTime:x,maxResponseTime:c,totalDataTransferred:r,requestsByMethod:l,statusCodeDistribution:d,errorTypes:m,slowestRequests:p,fastestRequests:o}},us=s=>{const t=Object.entries(s.requestsByMethod).map(([r,l])=>`
    ...
    <div class="flex items-center justify-between">
      ...
      </div>`:"",c=s.slowestRequests.map((r,l)=>`
...
`,hs=(s,t)=>{const i=t.length||Number(s.totalTestCases||0),a=(t.length?t.filter(r=>r.status==="passed").length:0)||Number(s.successfulTestCases||0),x=(t.length?t.filter(r=>r.status==="failed").length:0)||Number(s.failedTestCases||0),c=i?Math.round(a/i*100):s.successRate||0,n=c>=80?"text-green-600 bg-green-100":c>=60?"text-yellow-600 bg-yellow-100":"text-red-600 bg-red-100";return`
  <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-3 mt-3">
    ${Z("Success Rate",`${c}%`,"trending-up",n)}
...
`,fs=s=>{const t=is(s.status),i=ns(s.severity),a=`tc-${s.id}`;return`
  ...
  </div>`},bs=s=>{const t=ms(s.passed,s.total),i=t>=80?"text-green-600":t>=60?"text-yellow-600":"text-red-600",a=`url-${ys(s.key)}`,x=Object.values(s.methods).map(c=>`
    <div class="space-y-3">
      <div class="flex items-center gap-3">
        <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium border ${Fe(c.method)}">${c.method}</span>
      </div>
      <div class="space-y-3">
        ${c.testCases.map(n=>fs(n)).join("")}
      </div>
    </div>`).join("");return`
  <div class="border border-gray-200 rounded-lg overflow-hidden">
    ...
    </div>`:'<div class="bg-white rounded-lg shadow-md p-8 text-center"><i data-lucide="globe" class="w-12 h-12 text-gray-400 mx-auto mb-4"></i><p class="text-gray-500">No API requests found</p></div>'},ys=s=>{let t=0;for(let i=0;i<s.length;i++)t=(t<<5)-t+s.charCodeAt(i)|0;return`h${Math.abs(t)}`},js=(s,t,i)=>{let a=null;const x=document.getElementById(t)||document.body,c=x==null?void 0:x.querySelector('img[alt="Optraflow logo"]');c!=null&&c.src&&(a=c.src);const n=cs(s),r=ps(n),l=i.codeTheme==="dark"?"https://unpkg.com/prismjs@1/themes/prism-okaidia.css":"https://unpkg.com/prismjs@1/themes/prism.css";return`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
    ...
    <div class="header-meta">
      <div class="meta-item">
        ...
        <div>
          ...
          <div class="meta-value">${(()=>{const{dateTime:o,tz:u}=G(Date.parse(s.lastExecutionDate));return`${o}, ${u}`})()}</div>
        </div>
      </div>
      <div class="meta-item">
  ...
  <div class="metrics-grid">
    ...
    <div class="metric-card">
      <div>
        ...
        <div class="metric-value" style="font-size:18px">${c(d)}</div>
      </div>
      <div class="metric-icon" style="background:#fef3c7; color:#d97706;">
        <i data-lucide="database"></i>
      </div>
    ...
    <div class="section">
      ...
      ${s==null?void 0:s.requestExecutions.map(o=>`
        <div class="request-item">
          <div class="request-header">
            <div class="request-order">${o==null?void 0:o.order}</div>
            <div class="request-name">${m(o==null?void 0:o.name)}</div>
            <span class="method-badge method-${m(o==null?void 0:o.method.toLowerCase())}">${m(o.method)}</span>
            <span class="status-badge status-${m(o==null?void 0:o.status.toLowerCase())}">${m(o.status)}</span>
          </div>
          <div class="request-url">${m(o.url)}</div>
          <div class="request-stats">
            <span><strong>Status Code:</strong> ${o==null?void 0:o.responseStatusCode}</span>
            <span><strong>Duration:</strong> ${o==null?void 0:o.duration}ms</span>
            <span><strong>Size:</strong> ${m(c(o==null?void 0:o.responseSize))}</span>
          </div>
          ...
          <div style="margin-top: 16px;">
            ...
            <div class="code-block"><pre>${m(o.requestCurl)}</pre></div>
          </div>
          
          <div style="margin-top: 16px;">
            <strong style="font-size: 14px; color: #475569;">Response</strong>
            <div class="code-block"><pre>${m(o.response)}</pre></div>
          </div>
        </div>
      `).join("")}
    </div>
...
<\/script>
...
</html>`},r=()=>{try{const l=n(),d=new Blob([l],{type:"text/html;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a"),p=`${s.name.replace(/\s+/g,"_")}_Report_${new Date().getTime()}.html`;g.href=m,g.download=p,g.setAttribute("data-testid","download-link-html"),document.body.appendChild(g),g.click(),setTimeout(()=>{document.body.removeChild(g),URL.revokeObjectURL(m),t({title:"HTML Report Ready",description:"Your report has been downloaded successfully."})},100)}catch(l){console.error("HTML export error:",l),t({title:"Export Failed",description:"There was an error generating the HTML report.",variant:"destructive"})}};return e.jsx(se,{children:e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:r,"data-testid":"export-html-button",className:"p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors group",children:e.jsx(Te,{className:"w-5 h-5"})})}),e.jsx(L,{children:"Download HTML Report"})]})})}function Ts({reportData:s}){const{toast:t}=ee(),i=()=>{try{const a=new Oe,x=a.internal.pageSize.getWidth(),c=a.internal.pageSize.getHeight(),n=20;let r=n;a.setFontSize(20),a.setFont("helvetica","bold"),a.text(s.name,n,r),r+=8,a.setFontSize(10),a.setFont("helvetica","normal"),a.setTextColor(100,100,100),a.text("API Request Chain Execution Report",n,r),r+=15,a.setDrawColor(200,200,200),a.line(n,r,x-n,r),r+=10,a.setFontSize(12),a.setFont("helvetica","bold"),a.setTextColor(0,0,0),a.text("Execution Summary",n,r),r+=8,a.setFontSize(10),a.setFont("helvetica","normal"),[`Execution Date:  ${(()=>{const{dateTime:h,tz:y}=G(Date.parse(s.lastExecutionDate));return`${h}, ${y}`})()}`,`Duration: ${s.duration<1e3?`${s.duration}ms`:`${(s.duration/1e3).toFixed(2)}s`}`,`Executed By: ${s.executedBy}`,`Environment: ${s.environment}`].forEach(h=>{a.text(h,n+5,r),r+=6}),r+=5,a.setDrawColor(200,200,200),a.line(n,r,x-n,r),r+=10,a.setFontSize(12),a.setFont("helvetica","bold"),a.text("Performance Metrics",n,r),r+=8;const d=s.requestExecutions.length>0?Math.round(s.requestExecutions.reduce((h,y)=>h+y.duration,0)/s.requestExecutions.length):0,m=s.requestExecutions.reduce((h,y)=>h+y.responseSize,0),g=h=>h<1024?`${h} B`:h<1024*1024?`${(h/1024).toFixed(2)} KB`:`${(h/(1024*1024)).toFixed(2)} MB`;a.setFontSize(10),a.setFont("helvetica","normal");const p=n+5,o=x/2,u=(x-2*n-10)/2;a.setFillColor(240,240,240),a.rect(p-5,r-5,u,50,"F"),a.rect(o,r-5,u,50,"F"),a.setTextColor(0,0,0),a.setFont("helvetica","bold"),a.text("Total Requests",p,r),a.text("Success Rate",o+5,r),r+=7,a.setFontSize(18),a.setTextColor(33,150,243),a.text(s.totalRequests.toString(),p,r);const b=s.successRate===100?[76,175,80]:s.successRate>=80?[255,152,0]:[244,67,54];a.setTextColor(b[0],b[1],b[2]),a.text(`${s.successRate}%`,o+5,r),r+=10,a.setFontSize(10),a.setTextColor(0,0,0),a.setFont("helvetica","normal"),a.text(`Passed: ${s.successfulRequests}`,p,r),a.text(`Avg Response: ${d}ms`,o+5,r),r+=6,a.text(`Failed: ${s.failedRequests}`,p,r),a.text(`Data Transfer: ${g(m)}`,o+5,r),r+=6,a.text(`Skipped: ${s.skippedRequests}`,p,r),r+=15,a.setDrawColor(200,200,200),a.line(n,r,x-n,r),r+=10,a.setFontSize(12),a.setFont("helvetica","bold"),a.setTextColor(0,0,0),a.text("Request Execution Details",n,r),r+=8,a.setFontSize(9),a.setFont("helvetica","bold"),a.text("#",n,r),a.text("Request Name",n+10,r),a.text("Status",n+90,r),a.text("Duration",n+120,r),a.text("Status Code",n+155,r),r+=5,a.setFont("helvetica","normal"),[...s.requestExecutions].sort((h,y)=>h.order-y.order).forEach((h,y)=>{r>c-30&&(a.addPage(),r=n);const C=h.status==="passed"?[76,175,80]:h.status==="failed"?[244,67,54]:[158,158,158];a.setTextColor(0,0,0),a.text(h.order.toString(),n,r);const N=h.name.length>35?h.name.substring(0,32)+"...":h.name;a.text(N,n+10,r),a.setTextColor(C[0],C[1],C[2]),a.text(h.status.toUpperCase(),n+90,r),a.setTextColor(0,0,0),a.text(`${h.duration}ms`,n+120,r),a.text(h.responseStatusCode.toString(),n+155,r),r+=6}),r+=10,r>c-30&&(a.addPage(),r=n),a.setDrawColor(200,200,200),a.line(n,r,x-n,r),r+=5,a.setFontSize(8),a.setTextColor(150,150,150),a.text(`Generated on ${Ae(new Date,"MM/dd/yyyy 'at' h:mm a")} • OptraFlow API Testing Platform`,n,r);const E=`${s.name.replace(/[^a-z0-9]/gi,"_")}_Summary_${Date.now()}.pdf`;a.save(E),t({title:"PDF Summary Ready",description:`${E} has been downloaded.`})}catch(a){console.error("PDF export error:",a),t({title:"Export Failed",description:"There was an error generating the PDF. Please try again.",variant:"destructive"})}};return e.jsx(se,{children:e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:i,"data-testid":"export-html-button",className:"p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors group",children:e.jsx($e,{className:"w-5 h-5"})})}),e.jsx(L,{children:"Download PDF Summary"})]})})}const $s=({metrics:s})=>{const t=d=>{const m=Number(d??0);return m<1e3?`${m.toFixed(0)}ms`:`${(m/1e3).toFixed(2)}s`},i=s.reduce((d,m)=>d+(m.total||0),0),a=s.reduce((d,m)=>d+(m.success||0),0);s.reduce((d,m)=>d+(m.failed||0),0);const x=i>0?Math.round(s.reduce((d,m)=>d+(m.avgDurationMs||0)*(m.total||0),0)/i):0,c=s.length>0?Math.max(...s.map(d=>d.p95DurationMs||0)):0,n=i>0?a/i*100:0,r=`${n.toFixed(1)}%`,l=n>=80?"bg-green-100 text-green-700":n>=60?"bg-yellow-100 text-yellow-700":"bg-red-100 text-red-700";return!s||s.length===0?e.jsxs("div",{className:"bg-white rounded-lg border border-gray-200 p-6 mb-3",children:[e.jsxs("h2",{className:"text-xl font-bold text-gray-900 mb-2 flex items-center",children:[e.jsx(ge,{className:"w-6 h-6 mr-2 text-blue-600"}),"Request-Level Metrics"]}),e.jsx("p",{className:"text-gray-500 text-sm",children:"No metrics available."})]}):e.jsx("div",{className:"space-y-3 mb-3",children:e.jsxs("div",{className:"bg-white rounded-lg border border-gray-200 p-6",children:[e.jsxs("h2",{className:"text-xl font-bold text-gray-900 mb-6 flex items-center",children:[e.jsx(ge,{className:"w-6 h-6 mr-2 text-blue-600"}),"Request-Level Metrics"]}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-6",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"flex items-center justify-center w-12 h-12 bg-blue-100 rounded-full mx-auto mb-2",children:e.jsx(X,{className:"w-6 h-6 text-blue-600"})}),e.jsx("p",{className:"text-2xl font-bold text-gray-900",children:i}),e.jsx("p",{className:"text-sm text-gray-500",children:"Total Requests"})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:`flex items-center justify-center w-12 h-12 rounded-full mx-auto mb-2 ${l}`,children:e.jsx(_,{className:"w-6 h-6"})}),e.jsx("p",{className:"text-2xl font-bold text-gray-900",children:r}),e.jsxs("p",{className:"text-sm text-gray-500",children:["Success (",a," / ",i,")"]})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"flex items-center justify-center w-12 h-12 bg-purple-100 rounded-full mx-auto mb-2",children:e.jsx(D,{className:"w-6 h-6 text-purple-600"})}),e.jsx("p",{className:"text-2xl font-bold text-gray-900",children:t(x)}),e.jsx("p",{className:"text-sm text-gray-500",children:"Avg Response Time"})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"flex items-center justify-center w-12 h-12 bg-green-100 rounded-full mx-auto mb-2",children:e.jsx(W,{className:"w-6 h-6 text-green-600"})}),e.jsx("p",{className:"text-2xl font-bold text-gray-900",children:t(c)}),e.jsx("p",{className:"text-sm text-gray-500",children:"p95 Response Time"})]})]})]})})},U=()=>({total:0,passed:0,failed:0,skipped:0,apis:[]}),B=(s,t)=>{t&&(s.total+=t.total??0,s.passed+=t.passed??0,s.failed+=t.failed??0,s.skipped+=t.skipped??0,Array.isArray(t.testCases)&&t.testCases.forEach(i=>{const a={id:i.id,name:i.name,method:i.method,url:i.url,status:i.status,severity:i.severity,duration:i.duration,responseSize:i.responseSize,requestCurl:i.requestCurl,response:i.response};s.apis.push(a)}))},Cs=s=>{const t=U(),i=U(),a=U(),x=U(),c=U(),n=U(),r=U();let l=0,d=0,m=0,g=0;(s.requests??[]).forEach(v=>{l+=v.totalTestCases??0,d+=v.successfulTestCases??0,m+=v.failedTestCases??0,g+=v.skippedTestCases??0,B(t,v.positiveTests),B(i,v.negativeTests),B(a,v.functionalTests),B(x,v.semanticTests),B(c,v.edgeCaseTests),B(n,v.securityTests),B(r,v.advancedSecurityTests)});const p=[...t.apis,...i.apis,...a.apis,...x.apis,...c.apis,...n.apis,...r.apis],o=p.map(v=>v.duration??0),u=p.map(v=>v.responseSize??0),b=o.length?Math.min(...o):0,$=o.length?Math.max(...o):0,E=o.length?o.reduce((v,F)=>v+F,0)/o.length:0,h=u.reduce((v,F)=>v+F,0),y=new Set(p.map(v=>`${v.method} ${v.url}`)).size,C=l>0?Math.round(d/l*100):0;return{id:s.id,name:s.name,description:s.description??"",environment:s.environment??s.environmentId??"Unknown",lastExecutionDate:s.lastExecutionDate,duration:s.duration??0,executedBy:s.executedBy??"Unknown",successRate:C,totalTestCases:l,successfulTestCases:d,failedTestCases:m,skippedTestCases:g,requestMetrics:{minResponseTime:b,maxResponseTime:$,averageResponseTime:E,totalRequests:p.length,totalDataTransferred:h,uniqueEndpoints:y},positiveTests:t,negativeTests:i,functionalTests:a,semanticTests:x,edgeCaseTests:c,securityTests:n,advancedSecurityTests:r}},Rs=s=>{var n,r,l,d,m,g;const t=p=>new Date(p).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),i=p=>`${(p/1e3).toFixed(1)}s`,a=p=>{if(p===0)return"0 B";const o=1024,u=["B","KB","MB"],b=Math.floor(Math.log(p)/Math.log(o));return parseFloat((p/Math.pow(o,b)).toFixed(1))+" "+u[b]},x=[{title:"Positive Tests",category:s.positiveTests},{title:"Negative Tests",category:s.negativeTests},{title:"Functional Tests",category:s.functionalTests},{title:"Semantic Tests",category:s.semanticTests},{title:"Edge Case Tests",category:s.edgeCaseTests},{title:"Security Tests",category:s.securityTests},{title:"Advanced Security Tests",category:s.advancedSecurityTests}],c=Ms(x);return`
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 800px; margin: 0 auto; padding: 20px; background: white;">
      ...
      <div style="border-bottom: 2px solid #e5e7eb; padding-bottom: 20px; margin-bottom: 30px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-top: 20px;">
          ...
          <div style="text-align: center;">
            <div style="font-size: 20px; font-weight: 700; color: #111827;">${Object.keys(c).length}</div>
      ...
      <div style="margin-bottom: 30px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
          ...
          <tbody>
            ${Object.entries(c).slice(0,15).map(([p,o],u)=>{const b=Math.round(o.passedTests/o.totalTests*100);return`
                <tr style="background: ${u%2===0?"#ffffff":"#f9fafb"}; border-bottom: 1px solid #f3f4f6;">
                  <td style="padding: 8px; color: #374151; max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${o.endpoint}</td>
                  <td style="text-align: center; padding: 8px;">
                    <span style="background: ${Ss(o.method)}; color: white; padding: 2px 6px; border-radius: 4px; font-size: 10px; font-weight: 500;">${o.method}</span>
                  </td>
                  <td style="text-align: center; padding: 8px; color: #374151;">${o.totalTests}</td>
                  <td style="text-align: center; padding: 8px; color: ${b>=80?"#059669":b>=60?"#d97706":"#dc2626"}; font-weight: 600;">${b}%</td>
                  <td style="text-align: center; padding: 8px; color: #374151;">${o.avgDuration}ms</td>
                </tr>
              `}).join("")}
          </tbody>
        </table>
        ${Object.keys(c).length>15?`
      ...
      <div style="margin-bottom: 30px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px;">
          ${x.filter(p=>{var o;return((o=p==null?void 0:p.category)==null?void 0:o.total)>0}).map(({title:p,category:o})=>{const u=Math.round(o.passed/o.total*100);return`
              <div style="padding: 12px; border: 1px solid #e5e7eb; border-radius: 6px; background: #fafafa;">
                ...
                <div style="font-size: 11px; color: #6b7280;">
                  ${o.total} tests • ${u}% success
                </div>
                <div style="display: flex; gap: 8px; margin-top: 4px; font-size: 10px;">
                  <span style="color: #059669;">✓ ${o.passed}</span>
                  <span style="color: #dc2626;">✗ ${o.failed}</span>
                  ${o.skipped>0?`<span style="color: #d97706;">⚠ ${o.skipped}</span>`:""}
                </div>
              </div>
            `}).join("")}
        </div>
  ...
  `},Ss=s=>({GET:"#2563eb",POST:"#059669",PUT:"#d97706",DELETE:"#dc2626",PATCH:"#7c3aed",OPTIONS:"#6b7280"})[s]||"#6b7280",Es=async(s,t)=>{if(!document.getElementById(s))return;const a=window.__REPORT_DATA__;if(!a){alert("Report data not available for export");return}const[{default:x},{default:c}]=await Promise.all([xe(()=>import("./pdf-utils-B5L7NxEK.js").then(r=>r.h),__vite__mapDeps([0,1,2])),xe(()=>import("./pdf-utils-B5L7NxEK.js").then(r=>r.j),__vite__mapDeps([0,1,2]))]),n=document.createElement("div");n.style.cssText="position:absolute;left:-9999px;top:0;width:800px;background:#fff;",n.innerHTML=Rs(a),document.body.appendChild(n);try{const r=await x(n,{allowTaint:!0,useCORS:!0,backgroundColor:"#ffffff",scale:1,logging:!1,width:800,height:n.scrollHeight}),l=r.toDataURL("image/png"),d=new c({orientation:"portrait",unit:"mm",format:"a4",compress:!0}),m=210,g=295,p=r.height*m/r.width;let o=p,u=0;for(d.addImage(l,"PNG",0,u,m,p),o-=g;o>=0;)u=-(p-o),d.addPage(),d.addImage(l,"PNG",0,u,m,p),o-=g;d.save(t)}catch(r){console.error("Error generating PDF:",r),alert("Failed to generate PDF. Please try again.")}finally{document.body.removeChild(n)}},Ms=s=>{const t={};return s==null||s.forEach(({title:i,category:a})=>{if(!a)return;(a.apis??a.testCases??[]).forEach(c=>{const n=`${c.method} ${c.url}`;t[n]||(t[n]={endpoint:c.url,method:c.method,testCases:[],totalTests:0,passedTests:0,failedTests:0,skippedTests:0,avgDuration:0}),t[n].testCases.push({...c,category:i}),t[n].totalTests++,c.status==="passed"?t[n].passedTests++:c.status==="failed"?t[n].failedTests++:c.status==="skipped"&&t[n].skippedTests++})}),Object.values(t).forEach(i=>{const a=i.testCases.reduce((x,c)=>x+(c.duration??0),0);i.avgDuration=i.testCases.length?Math.round(a/i.testCases.length):0}),t},De=({openJiraModal:s,setOpenJiraModal:t,testSuiteData:i})=>{const[a,x]=w.useState(""),[c,n]=w.useState(""),[r,l]=w.useState("Bug"),[d,m]=w.useState(!1),[g,p]=w.useState(null),[o,u]=w.useState(null),[b,$]=w.useState(!1),E=typeof window<"u"?window.location.href:"";w.useEffect(()=>(s?document.body.style.overflow="hidden":document.body.style.overflow="unset",()=>{document.body.style.overflow="unset"}),[s]),w.useEffect(()=>{const j=R=>{R.key==="Escape"&&s&&!d&&f()};return document.addEventListener("keydown",j),()=>document.removeEventListener("keydown",j)},[s,d]);const h=j=>{try{const R=new Date(j);return isNaN(R.getTime())?"Invalid Date":R.toLocaleString("en-US",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZone:"UTC",timeZoneName:"short"})}catch{return"Invalid Date"}},y=()=>{const{name:j,lastExecutionDate:R,environment:k}=i;return`Name: ${j},
Executed date: ${h(R)},
Environment: ${k||"N/A"},
Execution url: ${E}
...
If you have access by providing the valid credentials you will be able to access the report.`},[C,N]=w.useState(!1),[v,F]=w.useState([]),{currentWorkspace:M}=te(),P=M==null?void 0:M.id,ae=async()=>{try{N(!0),u(null);const R=await await de(P||"");F(R)}catch(j){console.error(j),u(j.message||"Failed to fetch integrations")}finally{N(!1)}};w.useEffect(()=>{P&&ae()},[P]);const H=v==null?void 0:v.find(j=>j.type==="jira"&&j.isActive),K=H==null?void 0:H.id,O=async j=>{if(j.preventDefault(),!a.trim()){u("Summary is required");return}m(!0),u(null);try{const R={summary:a.trim(),description:y(),issueType:r},k=await Ge(K||"",R,P||"");if(!(k!=null&&k.issueKey)||!(k!=null&&k.issueUrl))throw new Error("Invalid response from server");p(k)}catch(R){console.error("Jira API Error:",R),u(R instanceof Error?R.message:"Failed to create Jira issue. Please try again.")}finally{m(!1)}},T=async()=>{if(g!=null&&g.issueUrl)try{if(navigator.clipboard&&window.isSecureContext)await navigator.clipboard.writeText(g.issueUrl);else{const j=document.createElement("textarea");j.value=g.issueUrl,j.style.position="fixed",j.style.left="-999999px",document.body.appendChild(j),j.select(),document.execCommand("copy"),document.body.removeChild(j)}$(!0),setTimeout(()=>$(!1),2e3)}catch(j){console.error("Failed to copy:",j),u("Failed to copy URL. Please copy manually.")}},f=()=>{d||(x(""),n(""),l("Bug"),p(null),u(null),$(!1),t())},z=j=>{j.target===j.currentTarget&&!d&&f()};return s?e.jsxs("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn",onClick:z,role:"dialog","aria-modal":"true","aria-labelledby":"modal-title",children:[e.jsxs("div",{className:"relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-slideUp",style:{maxHeight:"90vh"},children:[e.jsx("div",{className:"relative px-4 sm:px-6 py-4 sm:py-5",children:e.jsxs("div",{className:"flex items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("h2",{id:"modal-title",className:"text-xl sm:text-2xl font-bold text-black tracking-tight truncate",children:g?"Issue Created Successfully":"Create Jira Issue"}),e.jsx("p",{className:"text-black text-xs sm:text-sm mt-1",children:g?"Your bug report has been submitted":"Report a bug from test suite execution"})]}),e.jsx("button",{onClick:f,disabled:d,className:"p-2 rounded-lg hover:bg-white/20 transition-all duration-200 text-white disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0","aria-label":"Close modal",type:"button",children:e.jsx(qe,{size:24,className:"text-black"})})]})}),e.jsx("div",{className:"overflow-y-auto",style:{maxHeight:"calc(90vh - 100px)"},children:g?e.jsxs("div",{className:"p-4 sm:p-6 space-y-4 sm:space-y-6",children:[e.jsxs("div",{className:"text-center py-6 sm:py-8",children:[e.jsx("div",{className:"inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-green-400 to-emerald-600 mb-4 animate-scaleIn",children:e.jsx(le,{size:40,className:"text-white"})}),e.jsx("h3",{className:"text-xl sm:text-2xl font-bold text-slate-800 mb-2",children:g.message}),e.jsx("p",{className:"text-slate-600 text-sm sm:text-base px-4",children:"Your bug report has been successfully submitted to Jira"})]}),e.jsx("div",{className:"bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 sm:p-6 border border-indigo-100",children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-sm font-medium text-slate-600 block mb-2",children:"Issue Key"}),e.jsxs("div",{className:"flex items-center gap-3 flex-wrap",children:[e.jsx("span",{className:"text-2xl sm:text-3xl font-bold text-indigo-600 break-all",children:g.issueKey}),e.jsx("span",{className:"px-3 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded-full",children:"Created"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-sm font-medium text-slate-600 block mb-2",children:"Issue URL"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-2",children:[e.jsxs("a",{href:g.issueUrl,target:"_blank",rel:"noopener noreferrer",className:"flex-1 px-4 py-3 bg-white rounded-lg border border-indigo-200 text-indigo-600 hover:bg-indigo-50 transition-all duration-200 flex items-center justify-between group overflow-hidden min-w-0",children:[e.jsx("span",{className:"text-sm font-medium truncate mr-2",children:g.issueUrl}),e.jsx(_e,{size:18,className:"flex-shrink-0 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-200"})]}),e.jsx(re,{onClick:T,size:"lg",type:"button",children:b?e.jsxs(e.Fragment,{children:[e.jsx(le,{size:18}),e.jsx("span",{children:"Copied!"})]}):e.jsxs(e.Fragment,{children:[e.jsx(He,{size:18}),e.jsx("span",{children:"Copy URL"})]})})]})]})]})}),e.jsx("div",{className:"bg-blue-50 border border-blue-200 rounded-lg p-4",children:e.jsxs("div",{className:"flex gap-3",children:[e.jsx(J,{className:"text-blue-600 flex-shrink-0 mt-0.5",size:20}),e.jsxs("div",{className:"text-sm text-blue-800 min-w-0",children:[e.jsx("p",{className:"font-medium mb-1",children:"Share with your team"}),e.jsx("p",{className:"text-blue-700",children:"Copy the issue URL and share it with your team members. They can access the full report using their Jira credentials."})]})]})}),e.jsx("div",{className:"flex justify-end pt-2",children:e.jsx(re,{onClick:f,type:"button",children:"Close"})})]}):e.jsxs("form",{onSubmit:O,className:"p-4 sm:p-6 space-y-4 sm:space-y-6",children:[e.jsxs("div",{className:"bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-4 sm:p-5 border border-slate-200",children:[e.jsxs("h3",{className:"text-sm font-semibold text-slate-700 mb-3 flex items-center gap-2",children:[e.jsx(J,{size:16,className:"text-indigo-600 flex-shrink-0"}),e.jsx("span",{children:"Test Suite Information (Auto-populated)"})]}),e.jsxs("div",{className:"space-y-2 text-sm",children:[e.jsxs("div",{className:"flex flex-col sm:flex-row sm:gap-2",children:[e.jsx("span",{className:"font-medium text-slate-600 sm:min-w-[140px]",children:"Suite Name:"}),e.jsx("span",{className:"text-slate-800 break-words",children:i==null?void 0:i.name})]}),e.jsxs("div",{className:"flex flex-col sm:flex-row sm:gap-2",children:[e.jsx("span",{className:"font-medium text-slate-600 sm:min-w-[140px]",children:"Executed Date:"}),e.jsx("span",{className:"text-slate-800 break-words",children:h(i==null?void 0:i.lastExecutionDate)})]}),e.jsxs("div",{className:"flex flex-col sm:flex-row sm:gap-2",children:[e.jsx("span",{className:"font-medium text-slate-600 sm:min-w-[140px]",children:"Environment:"}),e.jsx("span",{className:"text-slate-800 break-words",children:(i==null?void 0:i.environment)||"N/A"})]}),e.jsxs("div",{className:"flex flex-col sm:flex-row sm:gap-2",children:[e.jsx("span",{className:"font-medium text-slate-600 sm:min-w-[140px]",children:"Executed By:"}),e.jsx("span",{className:"text-slate-800 break-words",children:i==null?void 0:i.executedBy})]})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("label",{htmlFor:"summary",className:"block text-sm font-semibold text-slate-700",children:["Summary ",e.jsx("span",{className:"text-red-500",children:"*"})]}),e.jsx(Ke,{id:"summary",type:"text",value:a,onChange:j=>x(j.target.value),placeholder:"Brief description of the bug",required:!0,maxLength:200,disabled:d,"aria-required":"true"}),e.jsxs("p",{className:"text-xs text-slate-500",children:[a.length,"/200 characters"]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"userDescription",className:"block text-sm font-semibold text-slate-700",children:"Additional Description"}),e.jsx(Ze,{id:"userDescription",value:c,onChange:j=>n(j.target.value),placeholder:"Add any additional details about the bug (steps to reproduce, expected vs actual behavior, etc.)",rows:3,maxLength:2e3,disabled:d}),e.jsxs("p",{className:"text-xs text-slate-500",children:[c.length,"/2000 characters"]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{htmlFor:"issueType",className:"block text-sm font-semibold text-slate-700",children:"Issue Type"}),e.jsxs("select",{id:"issueType",value:r,onChange:j=>l(j.target.value),disabled:d,className:"w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all duration-200 text-slate-800 bg-white cursor-pointer disabled:bg-slate-100 disabled:cursor-not-allowed",children:[e.jsx("option",{value:"Bug",children:"Bug"}),e.jsx("option",{value:"Task",children:"Task"}),e.jsx("option",{value:"Story",children:"Story"}),e.jsx("option",{value:"Epic",children:"Epic"})]})]}),o&&e.jsxs("div",{className:"p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3",role:"alert",children:[e.jsx(J,{className:"text-red-600 flex-shrink-0 mt-0.5",size:20}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-sm font-medium text-red-800",children:"Error creating issue"}),e.jsx("p",{className:"text-sm text-red-600 mt-1 break-words",children:o})]})]}),e.jsx("div",{className:"flex justify-end flex-col-reverse sm:flex-row gap-3 pt-4",children:e.jsx(re,{type:"submit",disabled:d||!a.trim(),size:"lg",children:d?e.jsxs("span",{className:"flex items-center justify-center gap-2",children:[e.jsxs("svg",{className:"animate-spin h-5 w-5",viewBox:"0 0 24 24","aria-hidden":"true",children:[e.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4",fill:"none"}),e.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),"Creating..."]}):"Create Issue"})})]})})]}),e.jsx("style",{children:`
      ...
      `})]}):null},Fs=()=>{const s=typeof window<"u"?window.location.search:"";return ne.useMemo(()=>new URLSearchParams(s),[s])},zs=s=>{var a,x;const t=[];if(Array.isArray(s==null?void 0:s.requests)){const c=["positiveTests","negativeTests","functionalTests","semanticTests","edgeCaseTests","securityTests","advancedSecurityTests"];for(const n of s.requests)for(const r of c){const l=n==null?void 0:n[r];(a=l==null?void 0:l.testCases)!=null&&a.length&&t.push(...l.testCases)}}const i=["positiveTests","negativeTests","functionalTests","semanticTests","edgeCaseTests","securityTests","advancedSecurityTests"];for(const c of i){const n=s==null?void 0:s[c];(x=n==null?void 0:n.apis)!=null&&x.length&&t.push(...n.apis)}return t},Ds=s=>{const t=zs(s),i=t.length||Number((s==null?void 0:s.totalTestCases)||0),a=(t.length?t.filter(l=>l.status==="passed").length:0)||Number((s==null?void 0:s.successfulTestCases)||0),x=(t.length?t.filter(l=>l.status==="failed").length:0)||Number((s==null?void 0:s.failedTestCases)||0),c=(t.length?t.filter(l=>l.status==="skipped").length:0)||Number((s==null?void 0:s.skippedTestCases)||0),n=i>0?Math.round(a/i*100):Number((s==null?void 0:s.successRate)||0),r=t.length>0?Math.round(t.reduce((l,d)=>l+Number((d==null?void 0:d.duration)||0),0)/t.length):Number.isFinite(s==null?void 0:s.duration)?Number(s.duration):0;return{total:i,passed:a,failed:x,skipped:c,successRate:n,avgDuration:r}},Ps=({data:s})=>{const t=w.useMemo(()=>Ds(s),[s]),i=w.useMemo(()=>Ns(s),[s]),a=T=>`${(T/1e3).toFixed(2)}s`,x=[{title:"Success Rate",value:`${t.successRate}%`,icon:_,color:t.successRate>=80?"text-green-600 bg-green-100":t.successRate>=60?"text-yellow-600 bg-yellow-100":"text-red-600 bg-red-100"},{title:"Total Test Cases",value:t.total.toString(),icon:D,color:"text-blue-600 bg-blue-100"},{title:"Passed",value:t.passed.toString(),icon:Q,color:"text-green-600 bg-green-100"},{title:"Failed",value:t.failed.toString(),icon:V,color:"text-red-600 bg-red-100"}],n=new URLSearchParams(window.location.search).get("executionId"),{type:r,entityId:l}=Ne(),d=()=>{Me(l,n||"")},m=async()=>{const T=Cs(s);window.__REPORT_DATA__=T,await Es("report-content",`${T.name}_report.pdf`)},g=()=>ss("report-content",`${s.name}_report.html`),p=()=>e.jsxs("svg",{viewBox:"0 0 48 48",xmlns:"http://www.w3.org/2000/svg",className:"w-6 h-6",fill:"none",children:[e.jsx("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"white"}),e.jsx("path",{d:"M34.9367 12H23.41C23.41 13.38 23.9582 14.7035 24.934 15.6793C25.9098 16.6551 27.2333 17.2033 28.6133 17.2033H30.7367V19.2533C30.7385 22.1245 33.0656 24.4515 35.9367 24.4533V13C35.9367 12.4477 35.489 12 34.9367 12Z",fill:"#2684FF"}),e.jsx("path",{d:"M29.2333 17.7433H17.7067C17.7085 20.6144 20.0355 22.9414 22.9067 22.9433H25.03V25C25.0337 27.8711 27.3622 30.1966 30.2333 30.1966V18.7433C30.2333 18.191 29.7856 17.7433 29.2333 17.7433Z",fill:"url(#paint0_linear)"}),e.jsx("path",{d:"M23.5267 23.4833H12C12 26.357 14.3296 28.6866 17.2033 28.6866H19.3333V30.7366C19.3352 33.6051 21.6582 35.9311 24.5267 35.9366V24.4833C24.5267 23.931 24.079 23.4833 23.5267 23.4833Z",fill:"url(#paint1_linear)"}),e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"paint0_linear",x1:"27.4434",y1:"15.326",x2:"22.5699",y2:"20.4112",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{offset:"0.18",stopColor:"#0052CC"}),e.jsx("stop",{offset:"1",stopColor:"#2684FF"})]}),e.jsxs("linearGradient",{id:"paint1_linear",x1:"376.829",y1:"349.939",x2:"167.455",y2:"557.146",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{offset:"0.18",stopColor:"#0052CC"}),e.jsx("stop",{offset:"1",stopColor:"#2684FF"})]})]})]}),[o,u]=w.useState([]),[b,$]=w.useState(!1),[E,h]=w.useState(null),{currentWorkspace:y}=te(),C=y==null?void 0:y.id,N=async()=>{try{$(!0),h(null);const f=await await de(C||"");u(f)}catch(T){console.error(T),h(T.message||"Failed to fetch integrations")}finally{$(!1)}};w.useEffect(()=>{C&&N()},[C]);const v=o==null?void 0:o.find(T=>T.type==="jira"&&T.isActive);v==null||v.id;const[F,M]=w.useState(!1),[P,ae]=w.useState({summary:"",description:"",issueType:""}),[H,K]=w.useState(!1);ee();const[,O]=ke();return e.jsxs("div",{id:"report-content",children:[e.jsxs("div",{className:"border border-gray-200 bg-background rounded-lg px-6 py-3 animate-fade-in mt-3",children:[e.jsxs("div",{className:"flex justify-between items-start mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-lg md:text-3xl font-bold text-gray-900 mb-2",children:s.name}),e.jsx("p",{className:"text-sm md:text-md text-gray-600",children:s.description})]}),e.jsx("div",{children:e.jsx("img",{src:Ee,alt:"Optraflow logo",className:"max-h-[50px] w-auto object-contain"})})]}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-6 mb-3",children:[e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(Ce,{className:"w-5 h-5 text-blue-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs md:text-sm text-gray-500",children:"Execution Date"}),e.jsx("p",{className:"text-xs md:text-sm font-semibold",children:(()=>{const{dateTime:T,tz:f}=G(s.lastExecutionDate);return`${T}, ${f}`})()})]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(D,{className:"w-5 h-5 text-green-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs md:text-sm text-gray-500",children:"Duration"}),e.jsx("p",{className:"text-xs md:text-sm font-semibold",children:a(s.duration)})]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(Re,{className:"w-5 h-5 text-purple-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs md:text-sm text-gray-500",children:"Executed By"}),e.jsx("p",{className:"text-xs md:text-sm font-semibold text-xs",children:s.executedBy})]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(W,{className:"w-5 h-5 text-orange-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs md:text-sm text-gray-500",children:"Environment"}),e.jsx("p",{className:"text-xs md:text-sm font-semibold text-xs",children:s.environment})]})]})]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs(se,{children:[e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:g,className:"p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors group",children:e.jsx(Te,{className:"w-5 h-5"})})}),e.jsx(L,{children:"Download html Report"})]}),e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:m,className:"p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors group",children:e.jsx($e,{className:"w-5 h-5"})})}),e.jsx(L,{children:"Download pdf Summary"})]}),e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:d,className:"p-2 text-green-600 hover:bg-green-50 rounded-lg transition-colors group",children:e.jsx(Se,{className:"w-5 h-5"})})}),e.jsx(L,{children:"Share Report"})]}),e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:()=>{v?M(!0):O("/settings/account?tab=external-tools")},className:"p-2 text-green-600 hover:bg-green-50 rounded-lg transition-colors",children:e.jsx(p,{})})}),e.jsx(L,{children:v?"Create Jira issue":"Configure Jira"})]})]}),e.jsx(De,{openJiraModal:F,setOpenJiraModal:()=>M(!1),testSuiteData:s})]})]}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6 mb-3 mt-3",children:x.map((T,f)=>e.jsx("div",{className:"border border-gray-200 bg-background rounded-lg px-6 py-6 animate-fade-in",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-xs md:text-sm text-gray-500 mb-1",children:T.title}),e.jsx("p",{className:"text-md md:text-2xl font-bold text-gray-900",children:T.value})]}),e.jsx("div",{className:`p-3 rounded-full ${T.color}`,children:e.jsx(T.icon,{className:"w-4 h-4 md:w-6 md:h-6"})})]})},f))}),e.jsx(ws,{metrics:i}),e.jsx(es,{report:s})]})};function Is(s){var r;const t=Number(s==null?void 0:s.totalRequests)||((r=s==null?void 0:s.requestExecutions)==null?void 0:r.length)||0,i=Number(s==null?void 0:s.successfulRequests)||0,a=Number(s==null?void 0:s.failedRequests)||0,x=Number(s==null?void 0:s.skippedRequests)||0,c=t||i+a+x,n=c?Math.round(i/c*100):0;return{total:c,successful:i,failed:a,skipped:x,successRate:n}}function As(s,t){if(!s.length)return 0;const i=[...s].sort((x,c)=>x-c),a=Math.min(i.length-1,Math.max(0,Math.ceil(t/100*i.length)-1));return i[a]}function Ls(s){const t=(s==null?void 0:s.requestExecutions)||[],i=new Map;t.forEach(c=>{const n=(c.method||"GET").toUpperCase();i.has(n)||i.set(n,[]),i.get(n).push(c)});const a=[];for(const[c,n]of i.entries()){const r=n.map(o=>Number(o.duration||0)).filter(o=>Number.isFinite(o)),l=n.length,d=n.filter(o=>o.status==="passed").length,m=n.filter(o=>o.status==="failed").length,g=r.length?Math.round(r.reduce((o,u)=>o+u,0)/r.length):0,p=Math.round(As(r,95));a.push({method:c,total:l,success:d,failed:m,avgDurationMs:g,p95DurationMs:p})}const x=["GET","POST","PUT","PATCH","DELETE"];return a.sort((c,n)=>{const r=x.indexOf(c.method),l=x.indexOf(n.method);return r===-1&&l===-1?c.method.localeCompare(n.method):r===-1?1:l===-1?-1:r-l}),a}const Us=({data:s,environment:t,startedQS:i})=>{var O,T;const a=((O=s.requestExecutions)==null?void 0:O.map((f,z)=>{var j,R;return{step:f.order||z+1,method:f.method,name:f.name,url:f.url,statusCode:f.responseStatusCode,requestCurl:f.requestCurl,response:f.response,responseSize:`${f.responseSize||0} bytes`,duration:`${f.duration}ms`,substitutedVariables:f.substitutedVariables||[],assertionResults:((j=f==null?void 0:f.assertionResults)==null?void 0:j.map(k=>({status:k.status,category:k.category,description:k.description,field:k.field,responseSize:k.responseSize,responseStatus:k.responseStatus,responseTime:k.responseTime,type:k.type,actualValue:k.actualValue,operator:k.operator,expectedValue:k.expectedValue})))??[],status:f.status==="passed"?"success":f.status==="failed"?"fail":"skipped",extractedVars:((R=f.extractedVariables)==null?void 0:R.map(k=>({key:k.name,value:k.value})))||[],errorMessage:f.status==="failed"?"Request failed":void 0}}))||[],x=s.globalVariables||{},c=((T=s.extractedVariables)==null?void 0:T.reduce((f,z)=>(f[z.name]=z.value,f),{}))||{},n=ne.useMemo(()=>Is(s),[s]),r=ne.useMemo(()=>Ls(s),[s]),l=n.successRate>=80?"text-green-600 bg-green-100":n.successRate>=60?"text-yellow-600 bg-yellow-100":"text-red-600 bg-red-100",d=[{title:"Success Rate",value:`${n.successRate}%`,icon:_,color:l},{title:"Total Requests",value:n.total.toString(),icon:D,color:"text-blue-600 bg-blue-100"},{title:"Successful",value:n.successful.toString(),icon:Q,color:"text-green-600 bg-green-100"},{title:"Failed",value:n.failed.toString(),icon:V,color:"text-red-600 bg-red-100"},{title:"Skipped",value:n.skipped.toString(),icon:Je,color:"text-red-600 bg-orange-100"}],m=f=>f<1e3?`${f}ms`:`${(f/1e3).toFixed(2)}s`,g=()=>e.jsxs("svg",{viewBox:"0 0 48 48",xmlns:"http://www.w3.org/2000/svg",className:"w-6 h-6",fill:"none",children:[e.jsx("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"white"}),e.jsx("path",{d:"M34.9367 12H23.41C23.41 13.38 23.9582 14.7035 24.934 15.6793C25.9098 16.6551 27.2333 17.2033 28.6133 17.2033H30.7367V19.2533C30.7385 22.1245 33.0656 24.4515 35.9367 24.4533V13C35.9367 12.4477 35.489 12 34.9367 12Z",fill:"#2684FF"}),e.jsx("path",{d:"M29.2333 17.7433H17.7067C17.7085 20.6144 20.0355 22.9414 22.9067 22.9433H25.03V25C25.0337 27.8711 27.3622 30.1966 30.2333 30.1966V18.7433C30.2333 18.191 29.7856 17.7433 29.2333 17.7433Z",fill:"url(#paint0_linear)"}),e.jsx("path",{d:"M23.5267 23.4833H12C12 26.357 14.3296 28.6866 17.2033 28.6866H19.3333V30.7366C19.3352 33.6051 21.6582 35.9311 24.5267 35.9366V24.4833C24.5267 23.931 24.079 23.4833 23.5267 23.4833Z",fill:"url(#paint1_linear)"}),e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"paint0_linear",x1:"27.4434",y1:"15.326",x2:"22.5699",y2:"20.4112",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{offset:"0.18",stopColor:"#0052CC"}),e.jsx("stop",{offset:"1",stopColor:"#2684FF"})]}),e.jsxs("linearGradient",{id:"paint1_linear",x1:"376.829",y1:"349.939",x2:"167.455",y2:"557.146",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{offset:"0.18",stopColor:"#0052CC"}),e.jsx("stop",{offset:"1",stopColor:"#2684FF"})]})]})]}),[p,o]=w.useState([]),[u,b]=w.useState(!1),[$,E]=w.useState(null),{currentWorkspace:h}=te(),y=h==null?void 0:h.id,C=async()=>{try{b(!0),E(null);const z=await await de(y||"");o(z)}catch(f){console.error(f),E(f.message||"Failed to fetch integrations")}finally{b(!1)}};w.useEffect(()=>{y&&C()},[y]);const N=p==null?void 0:p.find(f=>f.type==="jira");N==null||N.id;const[v,F]=w.useState(!1),[M,P]=w.useState({summary:"",description:"",issueType:""}),[ae,H]=w.useState(!1);ee();const[,K]=ke();return e.jsxs("div",{children:[e.jsxs("div",{className:"border border-gray-200 bg-background rounded-lg px-6 py-3 animate-fade-in mt-3",children:[e.jsxs("div",{className:"flex justify-between items-start mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-xl md:text-3xl font-bold text-gray-900 mb-2 break-words",children:s.name}),e.jsx("p",{className:"text-gray-600",children:s.description||"Request chain execution flow with variable extraction and data flow analysis"})]}),e.jsx("div",{children:e.jsx("img",{src:Ee,alt:"Optraflow logo",className:"max-h-[50px] w-auto object-contain"})})]}),e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-3",children:[e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(Ce,{className:"w-5 h-5 text-blue-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-gray-500",children:"Execution Date"}),e.jsx("p",{className:"text-sm font-semibold",children:(()=>{const{dateTime:f,tz:z}=G(s.lastExecutionDate);return`${f}, ${z}`})()})]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(D,{className:"w-5 h-5 text-green-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-gray-500",children:"Duration"}),e.jsx("p",{className:"font-semibold",children:m((s==null?void 0:s.duration)||0)})]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(Re,{className:"w-5 h-5 text-purple-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-gray-500",children:"Executed By"}),e.jsx("p",{className:"font-semibold text-xs",children:s.executedBy})]})]}),e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx(W,{className:"w-5 h-5 text-orange-500"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-gray-500",children:"Environment"}),e.jsx("p",{className:"font-semibold text-xs",children:s==null?void 0:s.environment})]})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsxs(se,{children:[e.jsx(ks,{reportData:s}),e.jsx(Ts,{reportData:s}),e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:()=>Me(entityId,executionId||""),className:"p-2 text-green-600 hover:bg-green-50 rounded-lg transition-colors group",children:e.jsx(Se,{className:"w-5 h-5"})})}),e.jsx(L,{children:"Share Report"})]}),e.jsxs(I,{children:[e.jsx(A,{asChild:!0,children:e.jsx("button",{onClick:()=>{N?F(!0):K("/settings/account?tab=external-tools")},className:"p-2 text-green-600 hover:bg-green-50 rounded-lg transition-colors",children:e.jsx(g,{})})}),e.jsxs(L,{children:[$?"Failed to load integrations":N?"Create Jira issue":"Configure Jira"," "]})]})]}),e.jsx(De,{openJiraModal:v,setOpenJiraModal:()=>F(!1),testSuiteData:s})]})]}),e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-6 mb-3 mt-3",children:d.map((f,z)=>e.jsx("div",{className:"border border-gray-200 bg-background rounded-lg px-6 py-6 animate-fade-in",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-gray-500 mb-1",children:f.title}),e.jsx("p",{className:"text-2xl font-bold text-gray-900",children:f.value})]}),e.jsx("div",{className:`p-3 rounded-full ${f.color}`,children:e.jsx(f.icon,{className:"w-6 h-6"})})]})},z))}),e.jsx($s,{metrics:r}),e.jsx(Ue,{steps:a}),e.jsx("div",{className:"bg-[#FAFAFA]",children:e.jsx(Be,{globalVariables:x,extractedVariables:c})})]})},nt=()=>{const{type:s,entityId:t}=Ne(),i=Fs(),a=i.get("env")||"Unknown",x=i.get("started"),c=i.get("executionId"),{currentWorkspace:n}=te(),r=w.useRef(null),{data:l,isLoading:d}=Le({queryKey:["execution-report",t,s,c],queryFn:async()=>{if(!t||!s||!c||!(n!=null&&n.id))throw new Error("Missing required parameters");return s==="test_suite"?ce.getTestSuiteReport(t,c,n.id):ce.getRequestChainReport(t,c,n.id)},enabled:!!t&&!!s&&!!c&&!!(n!=null&&n.id)});return w.useEffect(()=>{typeof window>"u"||s==="test_suite"&&(l!=null&&l.data)&&(window.__REPORT_DATA__=l.data)},[s,l]),e.jsxs("div",{className:"mx-auto p-1 sm:p-1",ref:r,children:[e.jsx("header",{className:"border border-gray-200 bg-background rounded-lg px-6 py-4 animate-fade-in",children:e.jsx("div",{className:"flex items-center justify-between",children:e.jsx("div",{children:e.jsx("h2",{className:"text-2xl font-semibold text-foreground",children:s==="test_suite"?"Test Suite Report":"Request Chain Report"})})})}),d?e.jsx(Ve,{message:"Loading Report"}):l!=null&&l.data?s==="test_suite"?e.jsx(Ps,{data:l.data}):e.jsx(Us,{data:l.data,environment:a,startedQS:x}):e.jsx("div",{className:"text-center py-8",children:e.jsx("p",{className:"text-gray-500",children:"No report data available"})})]})};export{nt as default};
